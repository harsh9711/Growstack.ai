...
export const ContentBox = () => {
  ...
  return (
    <div className="p-4 sm:p-0 flex sm:flex-row flex-col max-w-[1240px] gap-10 items-start justify-center mx-auto">
      <div className="flex flex-col gap-y-6 sm:sticky top-0">
        <div className="flex flex-col ">
          <Image src="/blog1.svg" width={162} height={162} alt="blog" />
          <h2 className="font-bold mt-4 text-[18px]">Josh Gould</h2>
          <p className="text-[14px] font-light">Blog writer</p>{" "}
        </div>{" "}
        <div className="flex flex-col gap-y-4">
          <h2 className="text-[24px] font-semibold">Contents</h2>
          <div className="flex flex-col text-blacl font-light gap-y-4 w-full">
            <Link href="#firstid" className={`flex flex-row gap-6 ${
              ...
              <h2
                className={
                  selectedSection === "firstid" ? "text-[#034737] font-extrabold" : "font-medium"
                }
            ...
            <Link href="#secondid" className={`flex flex-row gap-6 ${
              selectedSection === "secondid"
              ? "border-[#034737]  border-l-[4.8px] p-4"
              : ""
            }`} >
              <h2 className={
                  selectedSection === "secondid" ? "text-[#034737]  font-extrabold" : "font-medium"
                }onClick={() => handleClick("secondid")}>
                Omnis ipsum ratione optio sed quos aspernatur nam.
              </h2>
            </Link>
            <h2>Omnis ipsum ratione optio sed</h2>
          </div>
        </div>
      </div>
      <div className="max-w-[884px]">
        <div className="flex flex-col gap-y-6" id="firstid">
       ...
       <div id="secondid">   <h2 className="font-bold text-[24px]">
            Omnis ipsum ratione optio sed quos aspernatur nam.{" "}
          </h2>
          <p className="text-[16px] ">
            Maxime distinctio nulla aliquam. Illo voluptatibus nulla. Ut
