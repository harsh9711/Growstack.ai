...
export default function page() {
  ...
  return (
    <div className="p-4 sm:p-8 md:p-0 mt-20 sm:mt-30 md:mt-40 max-w-[1480px] mx-auto">
      <div className="space-y-4">
        <h1 className="text-[18px] sm:text-[28px] md:text-[42px] max-w-4xl mx-auto leading-normal text-center font-semibold bg-gradient-to-b from-black to-black/30 bg-clip-text text-transparent">
          We don't merely transcribe words; we craft them too.
        </h1>
        <div className="ring-1 ring-[#DADADA] p-1 sm:p-3 text-[14px] sm:text-[16px] md:text-[18px] md:p-4 rounded-full max-w-md sm:max-w-xl md:max-w-3xl mx-auto flex items-center gap-4">
      ...
      <div
        className="flex flex-col sm:flex-row w-full max-w-[1240px] my-8 sm:my-12 md:my-20 sm:max-h-[500px] md:max-h-[640px] h-full items-center bg-white rounded-[30px] border-[#E8E8E8] border shadow-lg mx-auto"
        data-aos="fade-up"
      >
        <div className="flex flex-col gap-y-4 sm:gap-y-6 md:gap-y-10 sm:mb-10 md:mb-20 items-start justify-start pl-4 sm:pl-6 md:pl-10 py-6 sm:pr-20 md:pr-44">
          ...
          <div className="flex flex-col gap-y-2 sm:gap-y-4 md:gap-y-6 items-start justify-start">
            <h1 className="text-[18px] sm:text-[24px] md:text-[32px] w-full leading-normal text-start font-semibold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
