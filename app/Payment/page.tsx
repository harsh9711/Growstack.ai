            ...
            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 px-12'>
                ...
                >
                    <div
                        ...
                        data-aos='fade-right'
                    >
                        <div className='flex xl:p-0 p-2 flex-col w-full gap-4' data-aos='fade-up'>
                        ...
                        {isLoggedIn ? (
                            ...
                            <div className='border-[#034737] text-[#034737] w-full flex justify-end' data-aos='fade-left'>
                                <Link href='/auth/register'>
                                    <button className='border-[#034737]  border rounded-xl font-semibold text-[#034737] px-10 py-4 '>Register</button>
                                </Link>
                            </div>
                        )}
                    </div>
