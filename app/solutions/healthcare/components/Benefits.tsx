...
const Box: React.FC<RectangleCardProps> = ({
  ...
  return (
    <div
      className={` max-w-[610px] rounded-[20px] bg-[#FFFFFF] border-[#E3E3E3] p-6  gap-x-8 flex flex-row items-start justify-center text-black h-full`}
      data-aos="fade-right"
    >
...
height={114}
      ...
      <div className="flex flex-col max-w-[325px] relative z-10 rounded-b-[20px] w-full h-full  gap-y-2 bg-white">
