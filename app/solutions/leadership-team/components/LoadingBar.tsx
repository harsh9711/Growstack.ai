    ...
    <div className="flex flex-col gap-y-4 ">
      <div className=" 2xl:items-start items-center justify-center flex flex-col gap-y-4 ">
        ...
        >
          ...
          <span className="text-black font-extralight">and collaboration </span>
        </h1>
      </div>
