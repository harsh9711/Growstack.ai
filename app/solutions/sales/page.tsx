  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative w-full 2xl:mt-20">
        <div className="2xl:flex  hidden   2xl:max-w-[1921px] w-full 2xl:max-h-[973px] h-full justify-center mx-auto   items-center gap-4  ">
          <ImageGalleryLine />
        </div>
        <div className="2xl:hidden  flex 2xl:max-w-[1921px] w-full 2xl:max-h-[973px] h-full justify-center mx-auto   items-center gap-4  ">
