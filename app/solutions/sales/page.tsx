...
const page = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center mx-auto overflow-hidden ">
      <section className="bg-gradient-to-r to-[#FFF4CB]/100 via-[#E6FFE2]/100 from-[#A9FF9B]/50 w-full mb-20">
        <Navbar
        ...
        <div className="relative flex items-center max-w-[1920px] w-full max-h-[1112px] h-full justify-center mx-auto">
          <div className="w-full flex flex-row justify-between brightness-110 relative left-52 items-center mt-32 mb-60">
            <div className="w-full gap-y-4 flex flex-col">
              <div
                data-aos="fade-right"
                data-aos-duration="1200"
                className="bg-white text-black py-2 px-4 text-center items-center justify-center flex text-[12px] rounded-full font-semibold uppercase max-w-[252px] shadow-lg w-full tracking-widest"
              >
              ...
              <div className="2xl:max-w-3xl w-full brightness-95">
                <h1
                  ...
                  className="text-[56px] max-w-2xl leading-12 text-black"
                >
                ...
                <p
                  data-aos="fade-right"
                  data-aos-duration="1500"
                  className="text-[18px] text-black mt-4 w-full max-w-[600px] leading-loose font-light"
                >
                ...
                <div className="flex flex-col gap-20 mt-10">
                  <div
                    data-aos="fade-right"
                    data-aos-duration="1500"
                    className="flex flex-row gap-8 group text-[18px]"
                  >
                    ...
                    <button className="border border-black flex items-center gap-2 text-black hover:font-bold font-medium py-4 px-7 rounded-xl shadow-md shadow-[#00000025]">
                      See demo
...
<section className="bg-[#034737] mx-auto w-full flex items-center justify-center py-20 2xl:mt-20">
  <div data-aos="fade-up" data-aos-duration="1800" data-aos-delay="600" className="flex flex-col items-center justify-center gap-y-10">
    <div>
      <LoadingBar />
    </div>
  </div>
