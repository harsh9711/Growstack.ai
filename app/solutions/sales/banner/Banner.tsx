                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="bannerContent">
                                <span className='user'>Growstack for Sales Team</span>
                                <h2 className='solsheading'><span>Transform your sales  </span> <br />process with Growstack</h2>
                                <p>Unlock the full potential of your sales team with Growstack's advanced suite of tools and features. Our platform addresses your biggest challenges and empowers your team to achieve and exceed their goals.</p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <img src="/solutions/herosales.svg" alt="banner" />
                            </div>
                        </div>
                    </div>
                </div>
