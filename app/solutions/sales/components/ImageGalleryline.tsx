  ...
  const images: ImageData[] = [
    {
      ...
      relatedImages: [
        {
          src: "/sales/solution3rdpage/sideimages/rep.svg",
          alt: "Related Image 1-1",
          id: 2,
        },
        {
          src: "/sales/solution3rdpage/sideimages/ai.svg",
          alt: "Related Image 1-2",
          id: 4,
        },
        {
          src: "/sales/solution3rdpage/sideimages/lead.svg",
    ...
    },
    {
      ...
      relatedImages: [
        ...
        {
          src: "/sales/solution3rdpage/sideimages/social.svg",
          alt: "Related Image 1-3",
          id: 1,
        },
      ],
            ...
            <div className="loading-svg relative w-full  xl:translate-y-24 2xl:translate-y-24 ">
              ...
              <div className="relative 2xl:-top-[920px] 2xl:left-[1000px] xl:-top-[850px] xl:left-[850px] overflow-x-hidden">
                <Image
                  ...
                  width={980}
                  height={600}
                  className=" w-[350px] h-[262.5px] hover-box202 overflow-x-hidden"
                  alt="Image 2"
