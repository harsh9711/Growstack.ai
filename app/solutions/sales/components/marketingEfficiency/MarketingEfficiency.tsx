...
const MarketingEfficiency: React.FC = () => {
    ...
    const images = [
        { src: "/images_growstack/solutions/aichat.svg", description: "Fast content" },
                        ...
                        <div className="row justify-content-center">
                            {images.map((image, index) => (
                                ...
                                data-aos-duration="1000" key={index}>
                                    <div className="imgBlock flex flex-col" onClick={() => handleClick(index)}>
                                        <img src={image.src} alt={image.description} />
                                       <button className='rounded-2xl p-1 border bg-white  text-[#034737] text-center'><h2 className='text-[24px]'>{image.description}</h2></button> 
                                    </div>
                                </div>
                            ))}
                        </div>
