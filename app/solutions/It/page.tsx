  ...
  return (
    <main className="">
      ...
      <Suspense fallback={<LoadingSpinner />}>
        ...
        <section className="overlflow-hidden flex flex-col py-20 xl:mt-10 w-full mb-20 2xl:mb-10  items-center justify-center mx-auto bg-[#2DA771]">
        ...
        <section className=" flex flex-col xl:mt-32 w-full mb-20 2xl:mb-10  items-center justify-center mx-auto bg-[#2DA771] pb-16">
          <div className="py-16">
            <div className="2xl:flex hidden  w-full h-full items-center justify-center mx-auto">
              <ImageGallerySecond />
            </div>
