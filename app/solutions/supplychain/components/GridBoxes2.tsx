...
const GridComponentSecond = () => {
      ...
      switch (selected) {
        case 1:
          return (
            ...
            <div className="rounded-2xl flex justify-center items-center relative z-[20] opacity-100">
              <Image src="/solutions/supply/boxes/boxsvgs/boxsvg1.svg" alt="Box 1" width={940} height={555} className="w-[900px] h-[500px] bg-cover z-[20]" />
            </div>
            <div className="flex z-[80] flex-row gap-2 w-full max-w-[750px] justify-center relative">
        ...
        case 2:
          ...
          <div className="rounded-2xl flex justify-center items-center relative z-[40] opacity-100">
              <Image src="/solutions/supply/boxes/boxsvgs/boxsvg2.svg" alt="Box 1" width={1240} height={755} className="w-[900px] h-[500px]   bg-cover z-[20]" />
              </div>
              <div className="flex  z-[80] flex-row items-center left-0 justify-center gap-2 w-full max-w-[750px]   relative">
        ...
        case 3:
          ...
          <div className="rounded-2xl flex justify-center relative  z-[40] items-center">
              <Image src="/solutions/supply/boxes/boxsvgs/boxsvg3.svg" alt="Box 1" width={1240} height={755} className="w-[900px] h-[500px]   bg-cover z-[20]" />
              </div>
              <div className="flex z-[80] flex-row gap-2 w-full max-w-[750px] justify-center relative">
              <div onClick={() => handleClick(1)} className="bg-white/14 border whitespace-nowrap shadow-md hover:shadow-lg max-w-[400px] w-full max-h-[82px] h-full text-center p-4 rounded-2xl">
                Risk assessment AI
        ...
        case 4:
          return (
            ...
            <div className="rounded-2xl flex justify-center items-center relative z-[40]">
              <Image src="/solutions/supply/boxes/boxsvgs/boxsvg4.svg" alt="Box 1" width={1240} height={755} className="w-[900px] h-[500px]   bg-cover z-[20]" />
            </div>
            <div className="flex z-[80] flex-row gap-2 w-full max-w-[750px] justify-center relative">
            <div onClick={() => handleClick(1)} className="bg-white/14 border whitespace-nowrap shadow-md hover:shadow-lg max-w-[400px] w-full max-h-[82px] h-full text-center p-4 rounded-2xl">
                Risk assessment AI
  ...
  >
    <Image
      src="/solutions/supply/boxes/box1.svg"
      alt="Box 1"
      width={400}
      height={420}
      className="w-[380px] h-[257px] 2xl:w-[480px] 2xl:h-[357px] hover-boxsupply1001"
    />
  </div>
  <div
  ...
  >
    <Image
      src="/solutions/supply/boxes/box2.svg"
      alt="Box 2"
      width={400}
      height={400}
      className="w-[380px] h-[257px] 2xl:w-[480px] 2xl:h-[357px] hover-boxsupply2001"
    />
  </div>
  <div className="rounded-[30px] opacity-0 relative 2xl:right-[810px] xl:right-[720px] top-44 flex justify-center items-center hover:scale-150 transition-transform duration-300">
    <Image
      src="/solutions/supply/boxes/main.svg"
      alt="Main"
      width={50}
      height={50}
    />
  ...
  >
    <Image
      src="/solutions/supply/boxes/box4.svg"
      alt="Box 3"
      width={380}
      height={400}
      className="w-[380px] h-[257px] 2xl:w-[480px] 2xl:h-[357px] hover-boxsupply3001"
    />
  </div>
  <div
  ...
  >
    <Image
      src="/solutions/supply/boxes/box3.svg"
      alt="Box 4"
      width={380}
      height={420}
      className="w-[380px] h-[257px] 2xl:w-[480px] 2xl:h-[357px] hover-boxsupply4001"
    />
  </div>
</div>
</> 
