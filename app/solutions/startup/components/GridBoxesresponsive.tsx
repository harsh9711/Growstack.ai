...
const GridComponentResponsive = () => {
  ...
  const handleComponentClick = () => {
      ...
      switch (selected) {
        ...
        case 2:
          ...
          <div className="rounded-2xl flex justify-center items-center relative z-[40] opacity-100">
              <Image src="/startup/boxsvgs/boxsvg1.svg" alt="Box 1" width={1240} height={755} className="w-[1100px]  bg-cover z-[20]" />
              </div>
       ...
       AI workflow builder
        ...
        case 3:
          ...
          <div className="rounded-2xl flex justify-center relative  z-[40] items-center">
              <Image src="/startup/boxsvgs/boxsvg2.svg" alt="Box 1" width={1240} height={755} className="w-[1100px]  bg-cover z-[20]" />
              </div>
              <div className="flex z-[80] flex-row gap-2 w-full max-w-[1070px] justify-center relative">
              <div onClick={() => handleClick(1)} className="bg-white border  font-medium text-[24px] whitespace-nowrap shadow-md hover:shadow-lg max-w-[400px] w-full max-h-[82px] h-full text-center p-4 rounded-2xl">
            AI workflow builder
        ...
        case 4:
          return (
            ...
            <div className="rounded-2xl flex justify-center items-center relative z-[40]">
              <Image src="/startup/boxsvgs/boxsvg3.svg" alt="Box 1" width={1240} height={755} className="w-[1100px]  bg-cover z-[20]" />
            </div>
            <div className="flex z-[80] flex-row gap-2 w-full max-w-[1070px] justify-center relative">
            <div onClick={() => handleClick(1)} className="bg-white border font-medium text-[24px]  whitespace-nowrap shadow-md hover:shadow-lg max-w-[400px] w-full max-h-[82px] h-full text-center p-4 rounded-2xl">
          AI workflow builder
    ...
    <>      
          ...
          <div className=" xl:grid grid-cols-3 relative  gap-x-10 xl:left-52   justify-center items-center">
  <div
  ...
  >
    <Image
      ...
      width={400}
      height={420}
      className="w-[350px] h-[257px] hover-boxstartup1"
    />
  </div>
  <div
  ...
  <div className="rounded-[30px] 2xl:opacity-100 opacity-0 relative right-[560px] top-44  flex justify-center items-center hover:scale-150 transition-transform duration-300">
    <Image
  ...
  >
    ...
    return <div className="flex flex-col justify-center 2xl:text-[14px] text-[8px] 2xl:p-0 p-4 relative 2xl:left-8 mx-auto items-center overflow-hidden" onClick={handleComponentClick}>  
{renderContent()}</div>;
  };
