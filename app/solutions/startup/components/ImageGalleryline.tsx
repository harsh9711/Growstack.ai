...
const ImageGalleryLine = () => {
  ...
  const images: ImageData[] = [
    {
      ...
      relatedImages: [
        ...
        { src: '/solutions/startup/sideimages/article.svg', alt: 'Related Image 1-3', id: 4 },
      ],
    },
    {
  ...
  return (
    <div style={{ position: 'relative', width: '1821px', height: '1163px',overflow: 'hidden' }} className="w-full h-full overflow-x-hidden">
      ...
      <div className='flex flex-col xl:flex-row 2xl:flex-row items-start mt-24 justify-center'>
        ...
        {selectedImage ? (
          <div className="flex flex-col  items-center">
           ...
           market fit
            ...
            <div>
              <Image
                className="xl:w-[1108px] w-full h-full 2xl:h-[560px] mt-6"
          ...
          <div className="relative w-full  xl:translate-y-60 2xl:translate-y-24 ">
          <svg className="2xl:flex xl:hidden  hidden  loading-svg" width="1424" height="595" viewBox="0 0 1424 595" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M654.676 1.49064C644.665 1.49064 636.55 9.60582 636.55 19.6164C636.55 30.1793 627.987 38.7421 617.424 38.7421H391.628V37.7421H617.424C627.435 37.7421 635.55 29.627 635.55 19.6164C635.55 9.05353 644.113 0.490644 654.676 0.490644H1188.97V0.491132H1251.18C1262.47 0.491132 1271.62 9.64137 1271.62 20.9288V167.691C1271.62 178.978 1262.47 188.129 1251.18 188.129H1064.71C1053.97 188.129 1045.27 196.831 1045.27 207.566V449.79H1047.45V450.79H1045.27V452.19H1044.27V450.79H631.886C620.599 450.79 611.449 441.64 611.449 430.352V407.888C611.449 397.153 602.746 388.451 592.011 388.451H350.555V388.45H204.416C193.128 388.45 183.978 379.3 183.978 368.012V297.102V222.39C183.978 211.655 175.275 202.953 164.54 202.953H20.9283C9.64087 202.953 0.490644 193.803 0.490644 182.515V58.1797C0.490644 46.8923 9.64088 37.7421 20.9283 37.7421H391.627V38.7421H20.9283C10.1932 38.7421 1.49064 47.4446 1.49064 58.1797V182.515C1.49064 193.25 10.1932 201.953 20.9283 201.953H164.54C175.828 201.953 184.978 211.103 184.978 222.39V297.102V368.012C184.978 378.748 193.68 387.45 204.416 387.45H351.893V387.451H592.011C603.298 387.451 612.449 396.601 612.449 407.888V430.352C612.449 441.087 621.151 449.79 631.886 449.79H1044.27V207.566C1044.27 196.279 1053.42 187.129 1064.71 187.129H1251.18C1261.91 187.129 1270.62 178.426 1270.62 167.691V20.9288C1270.62 10.1937 1261.91 1.49113 1251.18 1.49113H1182.72V1.49064H654.676Z" fill="#A9FF9B"/>
               ...
               <div className="relative 2xl:-top-[660px] 2xl:left-[100px] xl:-top-[550px] xl:left-[100px] overflow-x-hidden">
                 <Image
                   src="/startup/wire/wire1.svg"
                   width={970}
                   height={600} 
                 className="w-[350px] h-[262.5px] hover-boxstartup11"
                   alt="Image 1"
               ...
               <div className="relative 2xl:-top-[970px] 2xl:left-[1000px] xl:-top-[850px] xl:left-[900px] overflow-x-hidden">
               <Image
                   src="/startup/wire/wire2.svg"
                   width={980}
                   height={600} 
                   className="w-[350px] h-[262.5px] hover-boxstartup21"
                   alt="Image 2"
               ...
               <div className="relative 2xl:-top-[650px] z-[90] 2xl:left-[1040px] xl:-top-[650px] xl:left-[920px] overflow-x-hidden">
               <Image
                   src="/startup/wire/wire3.svg"
                   width={980}
                   height={600} 
                   className="w-[350px] h-[262.5px] hover-boxstartup31"
                   alt="Image 3"
               ...
               <div className="relative 2xl:-top-[1030px] z-[60] 2xl:left-[40px] xl:-top-[950px]  xl:left-[70px] overflow-x-hidden " >
               <Image
                   src="/startup/wire/wire4.svg"
                   width={970}
                   height={600} 
                   className="w-[350px] h-[262.5px] hover-boxstartup41"
                   alt="Image 4"
