  ...
  const images: ImageData[] = [
    {
      ...
      relatedImages: [
        {
          src: "/solutions/startup/sideimages/web.svg",
          alt: "Related Image 1-1",
          id: 2,
        },
        {
          src: "/solutions/startup/sideimages/social.svg",
          alt: "Related Image 1-2",
          id: 3,
        },
        {
          src: "/solutions/startup/sideimages/article.svg",
    ...
    },
    {
      ...
      relatedImages: [
        ...
        {
          src: "/solutions/startup/sideimages/chat.svg",
          alt: "Related Image 1-3",
          id: 1,
        },
      ],
        ...
        <div className="relative flex items-center justify-center">
          {selectedImage ? (
             ...
             flex flex-col gap-y-2 mb-4"
              >
                ...
                <h1 className="text-center text-white  text-[26px] 2xl:text-[42px] leading-normal">
                  ...
                  <span className="font-extralight text-[#A9FF9B]">
                    {" "}
                    fit faster
                  </span>
                </h1>
            ...
            <div className="relative w-full  xl:translate-y-60 2xl:translate-y-24 ">
              <svg
                className="2xl:flex xl:hidden  hidden  loading-svg"
                width="1424"
                height="595"
              ...
              <svg
                className="2xl:hidden  loading-svg xl:flex hidden translate-x-64"
                width="1272"
                height="453"
