  ...
  const images: ImageData[] = [
    {
      ...
      relatedImages: [
        ...
        {
          src: "/solutions/finance/sideimages/ai.svg",
          alt: "Related Image 1-2",
          id: 4,
        },
        {
          src: "/solutions/finance/sideimages/temp.svg",
              ...
              <div className="items-center justify-center flex flex-col gap-y-2 2xl:translate-y-[180px] xl:translate-y-[180px] absolute top-0 left-0 right-0">
                ...
                <h1 className="text-center text-[42px] leading-normal">
                  <span className="text-black font-bold">
                    Plan accurately, forecast effectively,
                  </span>{" "}
                  <br /> <span className="text-black font-bold">& </span>
                  <span className="text-black font-extralight">
