...
const ImageGalleryLine = () => {
  ...
  const images: ImageData[] = [
    {
      src: '/solutions/finance/imageshown/imageshown1.svg',
      alt: 'Image 1',
      id: 1,
      relatedImages: [
        { src: '/solutions/finance/sideimages/rep.svg', alt: 'Related Image 1-1', id: 2 },
        { src: '/solutions/finance/sideimages/ai.svg', alt: 'Related Image 1-2', id: 4 },
        { src: '/solutions/finance/sideimages/lead.svg', alt: 'Related Image 1-3', id: 3 },
      ],
    },
    {
      src: '/solutions/finance/imageshown/imageshown3.svg',
      alt: 'Image 2',
      id: 2,
      relatedImages: [
        { src: '/solutions/finance/sideimages/lead.svg', alt: 'Related Image 2-1', id: 3 },
        { src: '/solutions/finance/sideimages/ai.svg', alt: 'Related Image 1-2', id: 4 },
        { src: '/solutions/finance/sideimages/social.svg', alt: 'Related Image 1-3', id: 1 },
      ],
    },
    {
      src: '/solutions/finance/imageshown/imageshown4.svg',
      alt: 'Image 3',
      id: 3,
      relatedImages: [
        { src: '/solutions/finance/sideimages/rep.svg', alt: 'Related Image 3-2', id: 2 },
        { src: '/solutions/finance/sideimages/social.svg', alt: 'Related Image 2-1', id: 1 },
        { src: '/solutions/finance/sideimages/ai.svg', alt: 'Related Image 1-2', id: 4 },
      ],
    },
    {
      src: '/solutions/finance/imageshown/imageshown2.svg',
      alt: 'Image 4',
      id: 4,
      relatedImages: [
        { src: '/solutions/finance/sideimages/rep.svg', alt: 'Related Image 3-2', id: 2 },
  ...
  return (
    <div style={{ position: 'relative', width: '1700px', height: '900px' ,overflow: 'hidden' }} className="w-full h-full overflow-x-hidden ">
     
      <div className='flex flex-col 2xl:flex-row xl:flex-row items-start  justify-center'>
...
<path d="M1085.38 456.641H652.395C641.35 456.641 632.395 447.687 632.395 436.641V414.211C632.395 403.166 623.441 394.211 612.395 394.211H158.83" stroke="#034737"/>
            ...
            <div className="items-center justify-center flex flex-col gap-y-2 2xl:translate-y-[180px] xl:translate-y-[180px] absolute top-0 left-0 right-0">
              ...
              <h1 className="text-center text-[42px] leading-normal">
                <span className="text-black font-bold">Plan accurately, forecast effectively,</span> <br/> <span className="text-black font-bold">& </span>
                <span className="text-black font-extralight">maintain cash flow stability</span>
              </h1>
            </div>
            <div className="relative 2xl:-top-[660px] 2xl:left-[100px] xl:-top-[550px] xl:left-[50px] overflow-x-hidden">
              <Image
                  src="/solutions/finance/wire/wire1.svg"
                  width={970}
                height={600} 
              className="w-[350px] h-[262.5px] hover-boxfinance11 overflow-x-hidden"
                alt="Image 1"
            ...
            <div className="relative 2xl:-top-[920px] 2xl:left-[1000px] xl:-top-[850px] xl:left-[850px] overflow-x-hidden">
              <Image
                  src="/solutions/finance/wire/wire2.svg"
                  width={980}
                height={600} 
              className=" w-[350px] h-[262.5px] hover-boxfinance21 overflow-x-hidden"
                alt="Image 2"
            ...
            <div className="relative 2xl:-top-[700px] z-[90] 2xl:left-[1040px] xl:-top-[650px] xl:left-[920px] overflow-x-hidden">
              <Image
                  src="/solutions/finance/wire/wire3.svg"
                  width={980}
                height={600} 
              className="w-[350px] h-[262.5px] hover-boxfinance41 overflow-x-hidden"
                alt="Image 3"
            ...
            <div className="relative 2xl:-top-[1030px] z-[60] 2xl:left-[40px] xl:-top-[950px]  xl:left-[10px] overflow-x-hidden " >
              <Image
                  src="/solutions/finance/wire/wire4.svg"
                  width={970}
                height={600} 
              className="w-[350px] h-[262.5px] hover-boxfinance31 overflow-x-hidden"
                alt="Image 4"
