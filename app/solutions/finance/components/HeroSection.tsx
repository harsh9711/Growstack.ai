...
const HeroSection = () => {
  return (
    <section className="2xl:bg-[url('/animation3.png')] lg:bg-[url('/animation3.png')] md:bg-[url('/animation3.png')]xl:bg-[url('/animation3.png')]  h-full bg-gradient-to-b from-[#EFEBFA] to-[#FFFFFF] bg-cover  w-full mb-10 2xl:mb-20 items-center  bg-[100%] justify-center mx-auto">
