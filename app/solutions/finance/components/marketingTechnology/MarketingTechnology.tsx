  ...
  const slideData = [
    {
      ...
      description:
        "Automates the process of collecting, organizing, and managing financial data, ensuring accuracy and efficiency.",
    ...
    },
    {
      ...
      tags: ["AI Custom GPT"],
      description:
        "Tailors specific data integration solutions that fit your company’s needs, helping to integrate new technologies seamlessly.",
    ...
    },
    {
      ...
      tags: ["AI Assistants"],
      description:
        "Use CRMIntegrator AI to integrate customer relationship management with financial data systems, enhancing data flow and reducing manual entry.",
    ...
    },
    {
      ...
      description:
        "Automates scheduling and communication processes, ensuring timely updates and adherence to compliance deadlines.",
      icon: "/solutions/slideroperations/slider1.svg",
    },
    {
      title: "Collaboration",
      ...
      description:
        "Facilitates real-time communication among team members, ensuring everyone stays informed and aligned.",
      icon: "/solutions/slideroperations/slider2.svg",
    },
    {
      title: "Efficiency ",
      ...
      tags: ["Assistants"],
      description:
        "Employ Answer Bot AI to provide instant responses to common operational queries, enhancing communication and information sharing.",
      icon: "/solutions/slideroperations/slider3.svg",
    },
  ];
