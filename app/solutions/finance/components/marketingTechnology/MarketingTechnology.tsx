    ...
    const slideData = [
        {
            ...
            description: 'Automates the process of collecting, organizing, and managing financial data, ensuring accuracy and efficiency.',
        ...
        },
        {
            ...
            tags: ['AI Custom GPT'],
            description: 'Tailors specific data integration solutions that fit your company’s needs, helping to integrate new technologies seamlessly.',
        ...
        },
        {
            ...
            tags: ['AI Assistants'],
            description: 'Use CRMIntegrator AI to integrate customer relationship management with financial data systems, enhancing data flow and reducing manual entry.',
