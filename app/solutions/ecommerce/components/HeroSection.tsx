...
const HeroSection = () => {
  return (
    <div className="bg-[url('/backgroundimage.png')] rounded-b-[100px] bg-cover bg-no-repeat relative flex items-center fade-in-background 2xl:p-0 p-4 w-full 2xl:max-h-[1112px] h-full justify-center mx-auto">
      <div className="w-full max-w-[1220px] 2xl:max-w-[1350px]  flex flex-row justify-between brightness-110 relative gap-x-20  items-center mt-2 mb-6 2xl:mt-32 2xl:mb-40">
        <div className="w-full max-w-[700px] gap-y-4 sm:items-start items-center  flex flex-col">
          <div
            ...
            className="bg-[#A4E2CC] text-black py-2 2xl:px-4 text-center items-center justify-center flex text-[10px] 2xl:text-[12px] rounded-full font-semibold uppercase max-w-[300px] 2xl:max-w-[352px] shadow-lg w-full tracking-widest"
          >
            Growstack for Ecommerce
          </div>
            ...
            >
              <span className="font-semibold">
                ...
                <span className="font-light">
                  Transform your eCommerce business with AI-driven solutions{" "}
                </span>
              </span>{" "}
            </h1>
            <p
