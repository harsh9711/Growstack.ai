  ...
  const images: ImageType[] = [
    {
      ...
      className: "w-full h-full -translate-y-72 -translate-x-[500px] z-60",
    ...
    },
    {
      ...
      className: "w-full h-full -translate-x-[800px] z-60 translate-y-28",
    ...
    <>
      <div className="w-full">
        ...
        >
          ...
          <div className="items-center justify-center flex flex-col gap-y-2 w-full  absolute -top-40 -left-80 ">
