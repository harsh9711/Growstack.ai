...
const LoadingBar: React.FC = () => {
  ...
  const contents = [
    ...
    >
      <Image
        src="/iconsdivcustomer/icons1.svg"
        alt="Icon 1"
        width={50}
        height={50}
      />
    ...
    >
      <Image
        src="/iconsdivcustomer/icons2.svg"
        alt="Icon 2"
        width={50}
        height={50}
      />
    ...
    >
      <Image
        src="/iconsdivcustomer/icons3.svg"
        alt="Icon 3"
        width={50}
        height={50}
      />
    ...
    <div className="flex flex-col gap-y-6">
      <div className=" 2xl:items-start items-center justify-center flex flex-col gap-y-4 ">
        ...
        >
          ...
          <span className="text-[#61C453] font-normal">service standards </span>
        </h1>
      </div>
