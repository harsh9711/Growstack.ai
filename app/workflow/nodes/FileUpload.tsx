...
<h5 className="text-sm text-[#14171B] font-medium">File upload</h5>
              ...
              <div className="form-box">
                ...
                <div className="input-box mb-5">
                  <div className="label-box gap-2 align-middle mb-1">
                    <label className="font-medium text-[#14171B] text-[12px]">
                    ...
                    <div className="submit-button">
                  <button
className="bg-[#2DA771] flex contant-center text-white text-sm font-medium p-3 w-full rounded-[10px]"
