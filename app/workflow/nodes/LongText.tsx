...
const LongText = ({ data, id }: NodeProps<ChatGptNodeProps>) => {
    ...
    <div>
      {isNextBoxOpen ? (
        <div className="long-text-box" id="large-box">
          <div className="long-text-info-image">
          ...
          <div className="long-text-form bg-white p-4 border-2 border-[#2DA771] rounded-[20px] w-[400px] relative">
        ...
        <div className="long-text-box" id="small-box">
          <div className="long-text-info-image">
            <div className="long-text text-center">
              <h4 className="text-sm font-medium text-[#2DA771]">
                General input
          ...
          <div className="long-text-form bg-white p-4 border-2 border-[#2DA771] rounded-[20px] w-[400px] relative">
            ...
            <div className="form-box">
              <div className="input-box mb-5">
                <div className="label-box flex gap-2 align-middle mb-1">
                  <label className="font-medium text-[#14171B] text-[12px]">
                    Project Overview <span className="text-[#CF0000]">*</span>
                  </label>
