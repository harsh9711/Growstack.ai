    ...
    return (
        <div style={{ display: "flex", gap: '10px' }}>
            ...
            {dummyData1.map((item, index) => (
                <div
                    key={index.toString()}
                    className="h-[85px] w-[85px] p-2 bg-transparent rounded-[17.65px] flex justify-center items-center cursor-pointer"
                    style={{
                        border: `1.20px solid ${item.category === selectedCategory ? item.color.content : "#ffffff"}`,
                    }}
