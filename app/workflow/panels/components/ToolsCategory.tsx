                ...
                <div className="overflow-y-auto">
                    <div className="flex flex-wrap flex-row justify-evenly">
                        {Object.keys(groupedIntegrations).map((subCategory, index) => (
                            <div
                                key={index}
                                className={`flex flex-row m-0.5 p-2.5 rounded-lg items-center cursor-pointer ${selectedSubCategory === subCategory ? "bg-[#F1B916]" : "bg-[#E9E9E9]"}`}
                            ...
                            >
                                ...
                                /> */}
                                <p
                                    className={`ml-2 text-sm font-normal leading-4 ${selectedSubCategory === subCategory ? "text-white" : "text-[#14171B]"}`}
                                >
                                    {subCategory}
                                </p>
                            </div>
