...
export type OpenAiNodeProps = Node<
  { label: string; image: ImageProps },
  "open-ai"
>;

export type AnthropicNodeProps = Node<
  { label: string; image: ImageProps },
  "anthropic"
>;

export type GeminiNodeProps = Node<
  { label: string; image: ImageProps },
  "gemini"
>;

export type PerplexityNodeProps = Node<
  { label: string; image: ImageProps },
  "perplexity"
>;

export type MistralNodeProps = Node<
  { label: string; image: ImageProps },
  "mistral"
>;

export type GenerateImageNodeProps = Node<
  { label: string; image: ImageProps },
  "generate-image"
>;

export type ReadImageNodeProps = Node<
  { label: string; image: ImageProps },
  "read-image"
>;
