...
const ConfirmDialog = ({ isOpen, onClose, onConfirm, message, isLoading }: ConfirmDialogProps) => {
  return (
    <Dialog open={isOpen} onClose={onClose} as="div" className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
        ...
        <Dialog.Description className="mt-2 text-gray-700">{message}</Dialog.Description>
