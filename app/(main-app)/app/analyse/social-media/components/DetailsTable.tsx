...
const columns: ColumnDef<Activity>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div>
        {row.getValue("like")} <span className="text-green-500">+{row.original.likeChange}</span>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div>
        {row.getValue("accountReached")} <span className="text-red-500">{row.original.accountReachedChange}</span>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div>
        {row.getValue("postActivity")} <span className="text-green-500">+{row.original.postActivityChange}</span>
      </div>
    ),
  },
];
