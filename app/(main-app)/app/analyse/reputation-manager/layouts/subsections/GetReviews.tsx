    ...
    >
      ...
      <div className="mt-10">
        <div>
          ...
          <p className="mt-2">
            Select the template you want to use for this campaign. You can
            select the existing template, edit an existing template or create a
            new template.
          </p>
          <h2 className="text-xl font-semibold text-primary-green mt-6">
        ...
        <div className="mt-8 space-y-5">
          <h1 className="text-xl font-semibold">
            Choose when you are notified of feedback by email
          </h1>
          <p className="!mt-3">
            Select which review sites you want to direct people to leave reviews
            on.{" "}
        ...
        <div className="mt-8 space-y-5">
          ...
          <p className="!mt-3">
            Use “send campaign” if you’d like to import contacts and send them
            review via email or SMS. Use ‘Get request URLs’ If you’d like to get
            a review request URL for use in in-store kiosks, online sharing, or
            somewhere else.{" "}
          </p>
