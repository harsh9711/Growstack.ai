...
export default function OverviewGraphs() {
  const [selectedReviewsCategory, setSelectedReviewsCategory] =
    useState("All reviews");
  ...
  const reviewSourceBorderColors = [
    "#FF6384",
    "#36A2EB",
    "#FFCE56",
    "#4BC0C0",
            ...
            <div className="w-full flex justify-center">
              <button
                ...
                className={clsx(
                  ...
                  selectedReviewsCategory === "All reviews" &&
              ...
              <button
                ...
                className={clsx(
                  "text-sm h-12 py-2 px-4 rounded-md text-primary-black transition-all duration-300",
                  selectedReviewsCategory === "New reviews" &&
                    "text-white bg-primary-green"
                )}
              >
                New reviews
          ...
          <div className="flex gap-10 mt-6 px-10 py-4">
            <div className="flex">
              <DoughnutGraph
                ...
                backgroundColors={starRatingColors}
                borderColors={starRatingBorderColors}
              />
            </div>
            <div className="w-full flex items-center justify-center gap-4">
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#034737]"></span>5
                  stars (78.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#CC651D]"></span>4
                  stars (4.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#99B54F]"></span>3
                  stars (3.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#83A7F6]"></span>2
                  stars (3.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#F6D79E]"></span>1
                  stars (10.0%)
                </div>
              </div>
            </div>
        ...
        <section className="w-full bg-white border border-[#E4E4E4] p-10 rounded-3xl">
          ...
          <div className="flex gap-10 mt-6 px-10 py-4">
            ...
            <div className="w-full flex items-center justify-center gap-4">
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#FF6384]"></span>
                  Google (60.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#36A2EB]"></span>
                  Yelp (10.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#FFCE56]"></span>
                  Facebook (15.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#4BC0C0]"></span>
                  TripAdvisor (10.0%)
                </div>
                <div className="flex items-center gap-2 text-[17px] font-medium">
                  <span className="w-4 h-4 rounded-full bg-[#9966FF]"></span>
                  Others (5.0%)
                </div>
              </div>
            </div>
