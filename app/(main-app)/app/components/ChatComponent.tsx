...
export default function ChatComponent() {
  ...
  return (
    <div className="flex">
      ...
      <div
        className=" flex flex-col bg-white px-8 py-8 rounded-3xl border border-[#E8E8E8] w-full min-h-[580px] max-h-[580px] h-full"
      ...
      >
        ...
        >
          <div className="flex flex-row gap-2 items-center justify-center">
            <div
             className="flex items-center justify-center cursor-pointer xl:hidden"
