...
export default function ChatComponent() {
  ...
  return (
    <div className="h-[calc(100vh-180px)] flex flex-col bg-white p-10 pt-8 rounded-3xl border border-[#E8E8E8]">
      ...
      <div className="h-[calc(100vh-380px)] w-full flex-1 flex flex-col">
