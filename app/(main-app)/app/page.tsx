                  ...
                  {aiAppsloading ? (
                    ...
                    <div className="flex flex-col justify-center items-center space-y-3 col-span-2 py-8">
                      <h2 className="text-lg text-center font-semibold">
                        You have no AI writer templates added to your favorites
                        list.
                      </h2>
                      <p>
                        {" "}
                        Explore more templates to find the ones you like most.
                      </p>
                      <Link href="/app/plan/ai-templates">
                        <button className="bg-primary-green text-white py-3 px-5 rounded-lg sheen">
                          Explore more
                        </button>
                      </Link>
                    </div>
                    ...
                    favoriteAssistants.map((assistant, index) => (
                      ...
                      >
                        <Link
                          href={`/app/plan/ai-templates/${assistant._id}`}
                        ...
                        <div className="cursor-pointer w-full max-w-fit transition duration-300 hover:scale-125 flex justify-center items-center">
                          <BsStarFill
                            ...
                            onClick={() =>
                              handleFavourite("remove", assistant._id)
                            }
                          />
                        </div>
                      </div>
