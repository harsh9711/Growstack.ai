...
export default function FilterSheet() {
  ...
  return (
    <>
      <button
        className="border border-[#EBEBEB] rounded-lg grid place-content-center p-3 hover:bg-primary-light-gray text-primary-black"
        onClick={toggleSheet}
      >
        <FilterIcon size={20} />
      </button>
        ...
        <Sheet open={isOpen} onOpenChange={toggleSheet}>
          <SheetContent className="rounded-l-[40px]">
            <SheetHeader>
              ...
              <SheetDescription>Apply filters to leads.</SheetDescription>
            </SheetHeader>
