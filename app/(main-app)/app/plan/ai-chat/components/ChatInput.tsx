  ...
  (
    ...
    if (isDailyLimitExceeded) {
      return (
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-center items-center text-center mt-6">
          ...
          <Link className="bg-primary-green mt-3 text-nowrap text-white sheen transition duration-500 px-5 py-3.5 rounded-xl flex items-center gap-2" href="/Payment">
            Upgrade Your Plan
          </Link>
        </div>
      );
    ...
    return (
      <div className="flex p-2 border gap-2 rounded-xl items-end">
        ...
        <button onClick={() => handleSend()} className="h-12 w-12 flex justify-center items-center bg-primary-green hover:bg-opacity-90 transition-all duration-300 text-white rounded-xl">
          <SendIcon2 />
        </button>
      </div>
    );
