  ...
  return (
    <div className="bg-white border border-[#E8E8E8] rounded-2xl p-4">
      <div className="group relative rounded-2xl overflow-hidden group shadow-box">
        <Image src={avatar} alt={name} width={200} height={200} className="group-hover:scale-110 transition-all duration-300 min-h-[255px] w-full object-cover max-h-[255px]" />
