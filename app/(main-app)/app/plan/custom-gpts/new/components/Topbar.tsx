        ...
        <div className="flex items-center ">
          <div>
            ...
            <button className="text-[#212833] hover:bg-primary-green/10 sheen flex gap-2 px-3.5 py-2 rounded-full font-medium items-center">
              ...
              <h2 className='text-sm font-medium'>New GPT<span className="text-gray-400"> (Draft)</span></h2>
            </button>
          </Link>
            </p>
          </div>
...
<Button className="bg-primary-green text-white text-md   px-8 py-6 rounded-xl">
Create
</Button>
