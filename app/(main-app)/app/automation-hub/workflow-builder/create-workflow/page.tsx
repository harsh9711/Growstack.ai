...
export default function CreateWorkflowPage() {
  ...
  const handleRunDashboard = () => {
    setIsLoading(true);
    setTimeout(() => {
      window.location.href = `/app/automation-hub/workflow-builder/workflows/user-work-flow?workflow_id=${workflowId}`;
    }, 500);
  };
      ...
      <main className="flex-1 flex flex-col h-full w-full">
        <div className="mt-8 flex justify-between items-center">
          <div className="flex gap-3">
            <Link
              href="/app/automation-hub/workflow-builder/workflows"
              className="-mt-[5px]"
            >
