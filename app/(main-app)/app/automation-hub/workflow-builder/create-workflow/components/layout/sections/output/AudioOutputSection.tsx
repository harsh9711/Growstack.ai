...
export default function AudioOutputSection({
  ...
  const [params, setParams] = useState<AudioParams>({
    display_name: (outputParams as AudioParams).display_name || "",
    value: (outputParams as AudioParams).value || "",
    json_key: (outputParams as AudioParams).json_key || "",
  });
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="font-medium text-sm">Audio URL </label>
          <Input
            type="text"
