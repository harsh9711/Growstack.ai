...
export default function VideoOutputSection({ actions, inputConfigs, outputParams, onParamsChange, jsonKeyError, setJsonKeyError }: VideoOutputSectionProps) {
    ...
    <Motion transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            type="text" placeholder="https://example.com/video.mp3"
            ref={inputRef}
