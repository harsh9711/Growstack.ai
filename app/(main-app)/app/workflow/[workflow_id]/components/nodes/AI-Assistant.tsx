              ...
              <div className="node-image">
                ...
                {data?.icon && (
                  <img
                    src={data.icon}
                    alt={data.label}
                    className="h-[50%] w-auto rounded-full absolute left-0 right-0 mx-auto top-1/2 transform  -translate-y-1/2"
                  />
                )}
              </div>
              ...
              <div className="node-text-heading bg-[#FCF4DD] p-4 rounded-[16px] mb-2">
                {data?.icon && (
                  <img
                    src={data.icon}
                    alt={data.label}
                    className="w-[30px] rounded mb-2"
                  />
                )}
                <h4 className="text-base font-semibold text-[#14171B]">
                  {data?.label || ""}
                </h4>
              </div>
