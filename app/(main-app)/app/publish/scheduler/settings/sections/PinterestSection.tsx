    ...
    <Fragment>
      ...
      >
            ...
            <div className="w-full flex justify-between">
              ...
              >
                ...
                <div className="flex space-x-2 w-full">
                  ...
                  <label htmlFor="r2">Pinterest cookie method</label>
                </div>
              </RadioGroup>
            </div>
          </div>
          <div className="flex !mt-10">
            <label htmlFor="session_id" className="w-full max-w-[400px]">
              Enter session ID
            </label>
            <Input />
          </div>
        ...
        {/* <div className="mt-10 space-y-6">
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-1 w-1/5 min-w-[400px] font-medium">Autopost posts to Pinterest of this user(s)</label>
            <div className="w-full">
              <Select>
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-1 w-1/5 min-w-[400px] font-medium">Pinterest post image:</label>
