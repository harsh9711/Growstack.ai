    ...
    <Fragment>
      <Motion transition={{ duration: 0.2 }} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>
        ...
        <div className="mt-5 space-y-4 border-b border-[#00000015] pb-9 flex justify-between items-center">
          <h1 className="text-xl font-semibold text-primary-green">Blogger API settings</h1>
        ...
        <div className="mt-10 space-y-6">
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-1 w-1/5 min-w-[400px] font-medium">Blogger URL</label>
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-1 w-1/5 min-w-[400px] font-medium">Blogger post image</label>
            <div className="w-full flex gap-5">
              <Input type="text" className="w-full" />
              <button className="h-12 w-full max-w-[180px] text-primary-green border border-primary-green py-3 px-4 sheen flex justify-center items-center gap-3 rounded-xl hover:bg-primary-green transition-all duration-300 hover:text-white cursor-pointer">
                <Plus size={20} />
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-1 w-1/5 min-w-[400px] font-medium">Autopost Posts to Blogger of this user(s)</label>
