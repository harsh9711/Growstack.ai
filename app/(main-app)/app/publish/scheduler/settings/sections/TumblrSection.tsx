          ...
          <div className="flex mt-8">
            ...
            <div className="w-full">
              ...
              <p className="text-primary-black text-opacity-50 mt-3">
                Choose whether you want to post the full content or just a
                snippet to your Tumblr page. if you choose snippets, it will
                post the first 200 characters from your post.
              </p>
            </div>
          </div>
        </div>
        <div className="mt-8 space-y-4 border-b border-[#00000015] pb-9">
          ...
          <div className="flex items-center gap-4 !mt-7">
            <div className="space-y-3 w-full">
              ...
              <Input
                type="text"
                placeholder="Enter Twitter API key: Enter Twitter API key."
                className="w-full"
              />
            </div>
            <div className="space-y-3 w-full">
