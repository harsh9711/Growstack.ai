  ...
  return (
    <div className="w-full max-w-4xl bg-white px-10 py-14 rounded-3xl shadow-2xl shadow-gray-400">
      ...
      <p className="text-primary-black text-opacity-70 mt-3 text-[16px] leading-relaxed">
        You <span className="font-semibold">{params.get("profile")}</span> Page were successfully connected! Connect more profiles or click{" "}
        <span className="font-semibold">”Next”</span> to finish setting up your account.
      </p>
      <p></p>
      ...
      <div className="flex justify-end gap-4">
        <Link href="/app/publish/scheduler/quick-posting/posting">
          <button className="h-12 py-3.5 px-10 bg-primary-green sheen rounded-xl text-white mt-6">Next</button>
        </Link>
      </div>
    </div>
  );
