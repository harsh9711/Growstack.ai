...
const AddPages: FC<AddPagesProps> = ({
  ...
  const [response, setResponse] = useState<SocialMediaProfileResponse | null>(
    null
  );
  const [platformDetails, setPlatformDetails] = useState<SocialAccount | null>(
    null
  );
  ...
  const getDetailsByPlatform = (platform: string) => {
    const platformsdetails: any =
      response?.activeSocialAccounts?.filter(
              ...
              <div className="flex items-center justify-center ">
                <div className="grid grid-cols-2 grid-rows-2 gap-6 p-4  mt-0  ">
                  <div
                    ...
                    className="border border-[#034737] bg-[#034737] border-dotted rounded text-white p-2  w-[290px] h-[210px] flex items-center justify-center"
                  ...
                  {platformDetails && platformDetails.platform && (
                    <div
                      className="border border-[#034737] border-dotted rounded p-2 w-[290px] h-[210px] flex items-center justify-center"
                      style={{ cursor: "pointer" }}
                      onClick={handleOnConnect}
                    >
                      <div
                        className="absolute"
                        style={{ right: "81px", top: "10rem" }}
                      >
                        <svg
                          width="22"
                          height="22"
                      ...
                      <div className="flex flex-col items-center">
                        <div className="pb-3 w-[60px] h-[60px">
                          <img
                            src={platformDetails.userImage}
                            alt={platformDetails.displayName}
                          />
                        </div>
                        <div className="flex flex-col justify-center">
                          <div>
                            <p className="text-center font-bold text-xl pt-2">
