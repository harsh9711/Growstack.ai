      ...
      <main>
        <div className="flex justify-between items-center mt-8">
          <div className="space-y-2 w-full">
            <h1 className="text-2xl font-semibold">Add multi-posting content</h1>
        ...
        <section>
          ...
          <div className="bg-white rounded-3xl border border-[#EDEFF0] p-10 pt-16">
            <div className="flex gap-5">
              <div className="w-full space-y-7">
                <div className="flex items-center">
                  ...
                  <div className="w-full">
                    <Input type="url" placeholder="Content share link" className="w-full" />
                  </div>
                </div>
                <div className="flex items-center">
                  <label htmlFor="status" className="flex items-center gap-1 w-1/5 min-w-[300px] font-medium">
                    Post to this {tabs[selectedTabIndex]} account(s): <BsQuestion className="text-[#6A37E3]" size={20} />
                  </label>
                  <div className="w-full">
                    <Input type="url" placeholder="Content share link" className="w-full" />
                  </div>
                ...
                <div className="flex items-center">
                  <label htmlFor="status" className="flex items-center gap-1 w-1/5 min-w-[300px] font-medium">
                    Share posting type: <BsQuestion className="text-[#6A37E3]" size={20} />
                  </label>
                ...
                <div className="flex items-center">
                  <label htmlFor="status" className="flex items-center gap-1 w-1/5 min-w-[300px] font-medium">
                    Custom message: <BsQuestion className="text-[#6A37E3]" size={20} />
                  </label>
                  <div className="w-full">
                    <Input type="url" placeholder="Content share link" className="w-full" />
                  </div>
                ...
                <div className="flex items-center">
                  <label htmlFor="status" className="flex items-center gap-1 w-1/5 min-w-[300px] font-medium">
                    Schedule global: <BsQuestion className="text-[#6A37E3]" size={20} />
                  </label>
                  <div className="w-full">
                    <Input type="url" placeholder="Content share link" className="w-full" />
                  </div>
            ...
            <p className="mt-10 bg-[#6A37E3]/10 leading-relaxed flex items-center gap-2 py-2 px-4 rounded-lg italic">
              <Image src="/svgs/info.svg" alt="" width={30} height={30} /> You can only schedule the content if the current status set to unpublished.
            </p>
