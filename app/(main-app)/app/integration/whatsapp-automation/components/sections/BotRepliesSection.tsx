...
export const columns: ColumnDef<BotReply>[] = [
  {
    accessorKey: "no",
    header: ({ table }) => (
  ...
  {
    accessorKey: "type",
    header: () => <div className="uppercase">Type</div>,
    cell: ({ row }) => <p className="flex gap-2 items-center">{row.getValue("type")}</p>,
  },
  {
    accessorKey: "keywords",
    header: () => <div className="uppercase">Keywords</div>,
    cell: ({ row }) => <p className="flex gap-2 items-center">{row.getValue("keywords")}</p>,
  },
  {
    accessorKey: "replyText",
    header: () => <div className="uppercase">Reply Text</div>,
    cell: ({ row }) => <p className="flex gap-2 items-center">{row.getValue("replyText")}</p>,
  },
  {
    id: "actions",
    ...
    <Motion transition={{ duration: 0.2 }} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>
      <div className="w-full bg-white mt-10 rounded-3xl border border-[#E4E4E4]">
        <div className="flex justify-between items-center px-7 pt-5">
          <h1 className="text-2xl font-semibold">Bots & Quick replies</h1>
          <div className="flex justify-end gap-3 items-center w-full max-w-xl">
            ...
            <Link href="/app/integration/whatsapp-automation/create/new-bot-reply">
