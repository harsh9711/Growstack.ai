        ...
        <div className="flex items-start justify-between">
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="contact_image" className="bg-[#F2F2F2] h-12 px-4 py-3 text-primary-black text-opacity-80 min-w-fit rounded-lg cursor-pointer">
                Choose file
              </label>
            </div>
            <p className="text-sm text-[#CF0000] leading-relaxed">
              Note: Only .xlsx files are accepted. Please ensure that you upload the correct file format. You can download the sample file to understand the
              required structure.
            </p>
          </div>
