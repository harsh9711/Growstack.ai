      ...
      <div className="mt-8 flex-1 h-full w-full flex flex-col">
        <div className="flex-1 h-full w-full flex justify-center items-center mt-5">
          <div className="w-full max-w-2xl !bg-white border border-[#EDEFF0] rounded-3xl shadow-box p-10">
            <h1 className="text-xl font-semibold border-b border-[#EDEFF0] pb-4">Client information</h1>
            <div className="mt-4 flex flex-col gap-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="logo" className="bg-[#CECECE] h-12 px-4 py-3 text-primary-black text-opacity-80 min-w-fit rounded-lg">
                    Choose file
                  </label>
                </div>
              </div>
