    ...
    <Motion transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>
      <div className="mt-8">
        <div className="grid grid-cols-4 gap-5">
          <div className="bg-white p-7 rounded-3xl flex items-center hover:shadow-2xl hover:shadow-gray-200/80 cursor-pointer transition-all duration-500">
        ...
        <div className="bg-white p-10 rounded-3xl mt-5 space-y-7">
          <h1 className="text-xl font-semibold">Audience growth</h1>
