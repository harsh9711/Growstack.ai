...
export default function NewTelegramCampaign() {
  return (
    <div className="mt-8 flex-1 h-full w-full flex flex-col">
      ...
      <div className="flex-1 h-full w-full flex justify-center items-center gap-6 mt-5">
        <div className="w-full max-w-2xl  !bg-white border border-[#EDEFF0] rounded-3xl shadow-box p-10">
          <h1 className="text-xl font-semibold border-b border-[#EDEFF0] pb-4">Send new campaign</h1>
          <div className="mt-5 flex flex-col gap-6">
            ...
            <div className="space-y-2">
              <label className="font-medium">
                Text message <span className="text-[#F00]">*</span>
              </label>
              <textarea className="bg-[#F2F2F2] p-4 h-[120px] block resize-none w-full rounded-2xl" placeholder="Text message"></textarea>
            </div>

            <div className="space-y-2">
              <label className="font-medium">
                Contacts <span className="text-[#F00]">*</span>
              </label>
              <Select>
