...
export default function NewWhatsappCampaign() {
  return (
    <div className="mt-8 flex-1 h-full w-full flex flex-col">
      <Link href="/app/integration/campaigns">
      ...
      <div className="h-full w-full flex gap-6 mt-5">
        <div className="w-full !bg-white border border-[#EDEFF0] rounded-3xl shadow-box p-10">
          <h1 className="text-xl font-semibold border-b border-[#EDEFF0] pb-4">Send whatsapp notification</h1>
          <div className="mt-5 flex flex-col gap-6">
            <div className="space-y-2">
              <label className="font-medium">
                Campaign name <span className="text-[#F00]">*</span>
              </label>
              <Input type="text" placeholder="Campaign name" />
            </div>
            <div className="space-y-2">
              <label className="font-medium">
                Template <span className="text-[#F00]">*</span>
              </label>
              <Select>
            ...
            <div className="space-y-2">
              <label className="font-medium">
                Contacts list <span className="text-[#F00]">*</span>
              </label>
              <Select>
                <SelectTrigger className="w-full border-none px-4">
                  <SelectValue placeholder="Select Contacts list" />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="USA">USA</SelectItem>
            ...
            <div className="font-medium flex items-center gap-2">
              <Checkbox className="bg-[#F2F2F2] border-none" />
        ...
        <div className="w-full !bg-white border border-[#EDEFF0] rounded-3xl shadow-box p-10 grid place-content-center">
          <Image src="/assets/whatsapp-campaign.png" alt="" width={500} height={500} />
        </div>
      </div>
    </div>
  );
