...
export const columns: ColumnDef<BotReply>[] = [
...

  {
    ...
    cell: ({ row }) => <p className="flex gap-2 items-center">{row.getValue("category")}</p>,
  },
  {
    accessorKey: "language",
    header: () => <div className="uppercase">Language</div>,
    cell: ({ row }) => <p className="flex gap-2 items-center">{row.getValue("language")}</p>,
  },
  {
    id: "actions",
      ...
      <div className="w-full bg-white mt-10 rounded-3xl border border-[#E4E4E4]">
        <div className="flex justify-between items-center px-7 pt-5">
          ...
          <div className="flex justify-end gap-3 items-center w-full max-w-xl">
            ...
            <Link href="/app/integration/whatsapp-automation/create/new-template">
