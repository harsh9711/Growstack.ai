    ...
    cell: ({ row }) => {
      return (
        <div className="flex items-center justify-between max-w-[200px]">
          <button className="hover:bg-primary-green/10 px-3 py-2 text-primary-green font-medium rounded-lg transition-all duration-300">View</button>
          <button className="hover:bg-primary-green/10 px-3 py-2 text-primary-green font-medium rounded-lg transition-all duration-300">Pay</button>
        </div>
      );
    },
  },
