...
const Layout = () => {
  ...
  return (
    <div className="flex-1 max-h-[900px] flex  mt-10 shadow-lg rounded-3xl text-ellipsis">
      {showRightSidebar && (
        <aside className="w-full max-w-[350px] relative border bg-white rounded-l-3xl flex flex-col transition-all duration-300">
