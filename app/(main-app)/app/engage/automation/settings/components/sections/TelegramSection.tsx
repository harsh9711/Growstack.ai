        ...
        <div className="!bg-white border border-[#EDEFF0] p-7 rounded-3xl w-full">
          ...
          <div className="mt-5">
            <ul className="list-decimal translate-x-6 pr-6 space-y-3">
              ...
              <li>Start a chat with Bot Father and use the new bot command to create a new bot.</li>
              <li>Follow the instructions to set a name and username for your bot.</li>
              <li>After creating the bot, Bot Father will provide you with a token.</li>
              <li>To add a bot to a Telegram group and use it as an administrator to get group activity via the Telegram Bot API, follow these steps:</li>
                ...
                <ol className="translate-x-6 pr-6 space-y-3 list-[lower-alpha]">
                  <li className="mt-3">
                    ...
                    <ol className="space-y-3 translate-x-6 pr-6 mt-2 list-[lower-roman]">
                      ...
                      <li>Tap on the three dots in the top-right corner and select "Manage Group."</li>
                      <li>Click on "Administrators" and then "Add Administrator."</li>
                      <li>Search for your bot\'s username (e.g., @YourBotUsername) and add it as an administrator.</li>
                    </ol>
                  </li>
