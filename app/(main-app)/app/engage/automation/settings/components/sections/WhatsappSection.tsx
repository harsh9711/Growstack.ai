  ...
  return (
    ...
    >
      <div className="border border-[#EDEFF0] bg-white rounded-3xl p-6 mt-8">
        <div className="bg-[#C6F0D2] text-[#277A3E] p-4 rounded-lg">
          Success! You Are Now Connected To Whatsapp Cloud API
        </div>
          ...
          <div className="w-full space-y-4">
            ...
            <div className="!bg-white border border-[#EDEFF0] py-5 px-6 rounded-3xl w-full">
              <h1 className="text-xl font-semibold">
                Account ID and phone number ID
              </h1>
              <div className="space-y-3 mt-8">
                <div className="flex items-center">
          ...
          <div className="w-full space-y-4">
              ...
              <div className="mt-5">
                <ul className="list-decimal translate-x-6 pr-6 space-y-3">
                  <li className="leading-relaxed">
                    Sign up for a developer account and create a new Facebook
                    app by following the instructions provided on the Facebook
                    Developer website:{" "}
                    <Link
                  ...
                  <li className="leading-relaxed">
                    Once your Facebook app is created, navigate to the app
                    dashboard and find the WhatsApp product section. Click on
                    Setup.
                  </li>
                  <li className="leading-relaxed">
                    In the WhatsApp Configuration, enter the required
                    information including your Webhook Callback URL and Verify
                    Token.
                  </li>
                  <li className="leading-relaxed">
                    Go to Webhook fields and select Messages under Manage to
            ...
            <div className="!bg-white border border-[#EDEFF0] p-6 rounded-3xl w-full">
              ...
              <div className="mt-5">
                <ul className="list-decimal translate-x-6 pr-6 space-y-3">
                  <li className="leading-relaxed">
                    Follow The Detailed Process Outlined In The Facebook Docs To
                  ...
                  <li className="leading-relaxed">
                    Once You Have Obtained The Permanent access token Enter It
                    Here{" "}
                  </li>
                </ul>
              </div>
            ...
            <div className="!bg-white border border-[#EDEFF0] p-6 rounded-3xl w-full">
              ...
              <div className="mt-5">
                <ul className="list-decimal translate-x-6 pr-6 space-y-3">
                  <li className="leading-relaxed">
                    Navigate to the Facebook app, then go to Whatsapp -&gt; API
                    setup. Here, youwill find your Phone Number ID and your
                    WhatsApp Business Account ID.
                  </li>
                  <li className="leading-relaxed">
                    Copy them and enter them here.{" "}
                  </li>
                </ul>
              </div>
            </div>
