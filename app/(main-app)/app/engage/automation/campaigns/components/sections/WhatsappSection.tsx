...
import FilterDialog from "../dialogs/WhatsappFilterDialog";
...
export const columns: ColumnDef<Contact>[] = [
...

  {
    ...
    cell: ({ row }) => (
      <p className="flex gap-2 items-center">{row.getValue("total_contact")}</p>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <p className="flex gap-2 items-center">{row.getValue("statistics")}</p>
    ),
  },
  {
    id: "segments",
    ...
    >
      <div className="w-full bg-white mt-10 rounded-3xl border border-[#E4E4E4]">
        <div className="flex justify-between items-center px-7 pt-5">
          <h1 className="text-xl font-semibold">Campaigns list</h1>
          <div className="flex justify-end gap-3 items-center w-full max-w-5xl">
            ...
            <FilterDialog />
            <Link href="/app/integration/campaigns/create/new-whatsapp-campaign">
              ...
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow className="hover:bg-white">
                  <TableCell
                    ...
                    className="h-[50vh] text-center font-medium text-lg hover:bg-white"
                  >
