...
export const columns: ColumnDef<BotReply>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <p className="flex gap-2 items-center">{row.getValue("type")}</p>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <p className="flex gap-2 items-center">{row.getValue("keywords")}</p>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <p className="flex gap-2 items-center">{row.getValue("replyText")}</p>
    ),
  },
  {
    id: "actions",
