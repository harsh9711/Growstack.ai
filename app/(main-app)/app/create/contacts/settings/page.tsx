...
export default function SettingsPage() {
  ...
  return (
    <div className="mt-8">
      <Link href="/app/create/contacts">
        <button className="text-[#212833] hover:bg-primary-green/10 flex gap-2 px-3.5 py-2.5 rounded-full font-medium items-center">
      ...
      <div>{renderContent(selectedTabIndex)}</div>
    </div>
  );
}
