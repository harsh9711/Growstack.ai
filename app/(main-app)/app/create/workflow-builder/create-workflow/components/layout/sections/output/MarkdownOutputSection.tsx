...
interface MarkdownOutputSectionProps {
  onParamsChange: (params: MarkdownParams) => void;
  outputParams: MarkdownParams | {};
  actions: any;
  inputConfigs: any;
  jsonKeyError: string;
...
export default function MarkdownOutputSection({ actions, inputConfigs, outputParams, onParamsChange, jsonKeyError, setJsonKeyError }: MarkdownOutputSectionProps) {
  ...
  const [params, setParams] = useState<MarkdownParams>({
    display_name: (outputParams as MarkdownParams).display_name || "",
    value: (outputParams as MarkdownParams).value || "",
    json_key: (outputParams as MarkdownParams).json_key || "",
  });
  ...
  const updateParams = (updates: Partial<MarkdownParams>) => {
