...
export default function ImageOutputSection({ actions, inputConfigs, outputParams, onParamsChange, jsonKeyError, setJsonKeyError }: ImageOutputSectionProps) {
  ...
  const [params, setParams] = useState<ImageParams>({
    display_name: (outputParams as ImageParams).display_name || "",
    value: (outputParams as ImageParams).value || "",
    json_key: (outputParams as ImageParams).json_key || "",
  });
