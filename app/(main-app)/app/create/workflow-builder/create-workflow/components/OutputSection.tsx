  ...
  return (
    ...
    <Motion transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>
      ...
      {addNewOutput || outputConfigs.length ? (
        <AddOutput setAddNewOutput={setAddNewOutput} outputConfigs={outputConfigs} setOutputConfigs={setOutputConfigs} actions={actions} inputConfigs={inputConfigs} />
      ) : (
        <Fragment>
          <div className="mt-8 space-y-3">
            ...
            <div className="space-y-5 !mt-8">
              ...
              <span className="text-center block">Or</span>
                  <button className="w-full text-center border border-[#E8E8E8] text-primary-green hover:bg-primary-green/10 transition duration-500 px-5 py-4 rounded-xl flex items-center justify-center gap-2" onClick={handlePublishWorkFlow}>
                  <Send size={20} />
                  Publish
                </button>
            </div>
