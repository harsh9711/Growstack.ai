      ...
      {addNewInput ? (
        ...
        <Fragment>
          <div className="mt-8 space-y-3">
            <p className="text-primary-neutral text-xl font-semibold">Get started by adding inputs or steps</p>
            <p className="text-primary-black text-opacity-70 leading-relaxed text-sm">
              Get started by adding inputs or steps. Use inputs to run your workflow dynamically with different values each time. If you don't need inputs, you
              can start adding steps to your workflow in the canvas.
            </p>
