  ...
  return (
    <div>
        ...
        <div className="flex flex-row gap-10 text-md font-medium justify-between">
          <h2
            ...
            className={`cursor-pointer ${
              activeSection === "build" ? "border-b-4 border-green-800" : ""
            }`}
          >
            Build
          </h2>
          <h2
            ...
            className={`cursor-pointer ${
              activeSection === "run" ? "border-b-4 border-green-800" : ""
            }`}
          >
            Run
          </h2>
          <h2
            ...
            className={`cursor-pointer ${
              activeSection === "table" ? "border-b-4 border-green-800" : ""
            }`}
          >
            Table
          </h2>
      ...
      >
        <div
          ref={buildRef}
          className="flex-shrink-0 w-full h-full justify-center bg-white flex flex-col gap-6 pb-24"
        >
          <div className=" px-[550px]  p-10 snap-center gap-10 flex flex-col items-center pt-20">
            <div className="flex flex-col gap-2 p-2 items-center justify-center bg-[#0347371A] rounded-2xl w-40">
              <h1 className="text-md font-medium text-center text-[#14171B] *">
                Test workflow
              </h1>
            </div>
            <button
              ...
              <div className="flex flex-row p-4  justify-between">
                <div className="flex flex-row gap-4">
                  ...
                  <Image
                    ...
                    height={10}
                  />{" "}
                  <h2 className="text-lg">Build history</h2>
                </div>
                <svg
                  width="24"
                  height="24"
                ...
                >
                  ...
                  />
                  <path
                    d="M10.1094 13.6525L13.6894 10.0625"
                    stroke="#034737"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
        ...
        <div
          ref={tableRef}
          className="flex-shrink-0 w-full h-full min-w-[1000px] bg-white p-10 snap-center gap-10 flex flex-col"
        >
          ...
          <div className="flex justify-between items-center mt-4">
            <p className="text-sm text-gray-500">
              ...
              {Math.min(currentPage * 10, tableData.length)} of{" "}
