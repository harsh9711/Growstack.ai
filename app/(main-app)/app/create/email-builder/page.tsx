              ...
              {featuredTemplates.map((template) => (
                <div key={template.id}>
                  <div className="rounded-xl overflow-hidden mb-4 shadow-md shadow-gray-300/50 bg-white group">
                    <Link href={`/app/create/email-builder/design?type=featured&id=${template.id}`} target="_blank">
                      <img
                        width="100%"
                        height="100%"
                    ...
                    <div className="py-5 px-6 space-y-1.5">
                      <h5 className="line-clamp-1 text-[17px]">
          ...
          <div className="container space-y-14">
            ...
            <div className="grid grid-cols-4 gap-7">
              {defaultTemplates.map((template) => (
                <div key={template.id}>
                  <div className="rounded-xl overflow-hidden mb-4 shadow-md shadow-gray-300/50 bg-white group">
                    <Link href={`/app/create/email-builder/design?type=default&id=${template.id}`} target="_blank">
                      <img
                        width="100%"
                        height="100%"
                        className="group-hover:opacity-80 transition-all duration-300"
          ...
          <div className="container space-y-14">
            ...
            <div className="grid grid-cols-4 gap-7">
              {customTemplates.map((template) => (
                <div key={template.id}>
                  <div className="rounded-xl overflow-hidden mb-4 shadow-md shadow-gray-300/50 bg-white group">
                    <Link href={`/app/create/email-builder/design?type=custom&id=${template.id}`} target="_blank">
                      <img
                        width="100%"
                        height="100%"
                        className="group-hover:opacity-80 transition-all duration-300"
