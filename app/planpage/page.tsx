...
const page = () => {
  ...
  return (
    ...
    <h2 className='text-[24px] font-semibold z-[40] absolute -translate-y-32 translate-x-10'>Subscription models</h2>
...
<path d="M21.0547 10.1917L22.2997 11.4367L13.4835 20.2529L9.09229 15.8595L10.3373 14.6152L13.4857 17.7635L21.0547 10.1917Z" fill="white"/>
          ...
          <div className='flex flex-col gap-y-2 w-full max-w-[296px] items-center justify-center group hover:h-[239px] hover:bg-[#104D5B] rounded-2xl px-20 relative'>
    <div className='absolute bg-white text-[#034737] p-2 rounded-full px-16 -translate-y-28 opacity-0'>Best Value</div>
    <h2 className='text-[20px] text-center font-light group-hover:text-white'>Basic</h2>
    <h2 className='text-[28px] text-center font-semibold group-hover:text-[#A9FF9B]'>US$39.99</h2>
    <h2 className='text-[16px] text-center font-light group-hover:text-white'>Per Month</h2>
    <button className='border-[#034737] group-hover:text-white group-hover:border-white text-[#034737] border p-4 max-w-[220px] w-full rounded-2xl px-20 text-center items-center justify-center whitespace-nowrap relative z-20  '>
    <h2 className='text-center -translate-x-14 text-[#034737] group-hover:text-white'>Subscribe now</h2>
    </button>
</div>
            <div className='flex flex-col gap-y-2 w-full max-w-[296px] items-center justify-center group hover:h-[239px] hover:bg-[#104D5B] rounded-2xl px-20 relative'>
    <div className='absolute bg-white text-[#034737] p-2 rounded-full px-16 -translate-y-28  group-hover:opacity-100 opacity-0'>Best Value</div>
    <h2 className='text-[20px] text-center font-light group-hover:text-white'>Pro</h2>
    <h2 className='text-[28px] text-center font-semibold group-hover:text-[#A9FF9B] ] whitespace-nowrap'>US$ 99.99</h2>
    <h2 className='text-[16px] text-center font-light group-hover:text-white'>Per Month</h2>
    <button className='border-[#034737] group-hover:text-white group-hover:border-white text-[#034737] border p-4 max-w-[220px] w-full rounded-2xl px-20 text-center items-center justify-center whitespace-nowrap relative z-20  '>
    <h2 className='text-center -translate-x-14 text-[#034737] group-hover:text-white'>Subscribe now</h2>
    </button>
            ...
            <div className='flex flex-col gap-y-2 w-full max-w-[296px] items-center justify-center group hover:h-[239px] hover:bg-[#104D5B] rounded-2xl px-20 relative'>
    <div className='absolute bg-white text-[#034737] p-2 rounded-full px-16 -translate-y-28 opacity-0 '>Best Value</div>
    <h2 className='text-[20px] text-center font-light group-hover:text-white'>VIP</h2>
    <h2 className='text-[28px] text-center font-semibold group-hover:text-[#A9FF9B] ] whitespace-nowrap'>US$ 199.99</h2>
    <h2 className='text-[16px] text-center font-light group-hover:text-white'>Per Month</h2>
    <button className='border-[#034737] group-hover:text-white group-hover:border-white text-[#034737] border p-4 max-w-[220px] w-full rounded-2xl px-20 text-center items-center justify-center whitespace-nowrap relative z-20  '>
    <h2 className='text-center -translate-x-14 text-[#034737] group-hover:text-white'>Subscribe now</h2>
    </button>
...
<div className='flex flex-col gap-y-2 w-full max-w-[296px] items-center justify-center group hover:h-[239px] hover:bg-[#104D5B] rounded-2xl px-20 relative'>
    <div className='absolute bg-white text-[#034737] p-2 rounded-full px-16 -translate-y-28 opacity-0  z-10'>Best Value</div>
    <h2 className='text-[20px] text-center font-light group-hover:text-white'>Business</h2>
    <h2 className='text-[28px] text-center font-semibold group-hover:text-[#A9FF9B] whitespace-nowrap'>US$ 599.99</h2>
    <h2 className='text-[16px] text-center font-light group-hover:text-white'>Per Month</h2>
    <button className='border-[#034737] group group-hover:text-white group-hover:border-white text-[#A9FF9B] border p-4 max-w-[220px] w-full rounded-2xl px-20 text-center items-center justify-center whitespace-nowrap relative z-20   '>
    <h2 className='text-center -translate-x-14 text-[#034737] group-hover:text-white'>Subscribe now</h2>
    </button>
</div>
...
<div className='bg-[#03473712] flex flex-row gap-80 p-4 rounded-2xl h-[204px]'>
    <h2 className='text-center font-semibold whitespace-nowrap translate-x-20 mt-4'>User Benefits</h2>
    <div className='flex flex-row text-[14px] text-center gap-20 mt-4'>
        <p className='w-[205px] '>Users of ChatGPT or Gemini can access multiple agnostic LLMs in one place at a lower cost.</p>
        <p className='w-[205px] '>
        Influencers can streamline post management, scheduling, and analytics on a single platform.
        </p>
        <p className='w-[205px] '>
        New business can enhance brand awareness, streamline marketing, cut costs, and focus on personalization.
        </p>
        <p className='w-[205px] '>
        SME & LE’s benefit from personalized marketing, quicker campaign execution, and efficient content creation, leading to reduced marketing expenses.
        </p>
    </div>
</div>
</div>
...
<div className=' flex flex-row gap-56 p-4 rounded-2xl h-[87px]'>
    <h2 className='text-left font-semibold whitespace-nowrap translate-x-20 mt-4'>AI Apps, AI Chat, AI Assistants,<br/> 
    AI Playground, Custom GPT</h2>
    <div className='flex flex-row text-[14px] text-center gap-20 mt-4'>
...
<div className='bg-[#03473708] flex flex-row gap-80 p-4 rounded-2xl h-[87px]'>
    <h2 className='text-center font-semibold whitespace-nowrap translate-x-20 mt-4'>AI Article Wizard
   </h2>
    <div className='flex flex-row text-[14px] text-center gap-20 mt-4'>
