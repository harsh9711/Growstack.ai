...
const Carousel = () => {
  ...
  return (
    <div className="bg-[#F4F6F6] rounded-[60px]">
      ...
      <div className="flex items-center space-x-4 text-[16px] sm:text-[28px] px-20 font-bold">
      ...
      <div
        ...
        className="sm:flex hidden  flex-wrap xl:flex-row gap-4 2xl:gap-6  py-10 items-center justify-center mx-auto"
      >
      ...
      <div
        data-aos="slide-right"
        className="sm:hidden flex  flex-col  gap-4 2xl:gap-6  py-10 items-center justify-center mx-auto"
      >
        {solutions.map((item, index) => (
          <Link key={index} href={item.href}>
            <div
      ...
      <div className="flex items-center space-x-10 text-[16px] sm:text-[28px] px-20 font-bold">
        <div className="flex-1 border-t-2 border-dashed border-gray-400"></div>
      ...
      <div
        data-aos="slide-right"
        className="hidden sm:flex flex-wrap xl:flex-row gap-4 2xl:gap-6  py-10 pb-20 items-center justify-center mx-auto"
      >
