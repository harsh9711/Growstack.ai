    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4" data-aos="fade-up">
          <h2 className="text-white font-bold xl:text-[42px] text-[24px] tracking-widest">
            {title}
          </h2>
        ...
        <div className="max-w-[350px] w-full flex justify-end" data-aos="fade-left">
          <p className="justify-end text-white text-[18px] font-light">
            {description}
          </p>
        </div>
      </div>
