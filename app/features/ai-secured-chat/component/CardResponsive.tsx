      ...
      <div className="flex flex-col gap-y-10 sm:gap-y-48">
        <div className="text-black sm:items-start items-center  justify-start flex flex-col gap-y-4">
          ...
          <h1 className="text-left sm:text-left items-center justify-center  flex flex-wrap gap-2 text-[26px] 2xl:text-[42px] leading-normal">
            ...
            <p className="sm:text-[18px]  text-center font-extralight text-[16px]  max-w-[820px]">
              Growstack's <span className="font-bold"> Secure Chat</span>AI is
              built for businesses that need fast, intuitive, and secure
              communication. With flexible AI models, audio support, and
              customizable brand voice settings, it's the perfect tool for
        ...
        <div className="flex flex-col gap-y-10 items-center justify-center ">
          <RectangleCard
            ...
            secondtext="Speak naturally—our AI can process audio inputs and generate accurate responses."
            imgsrc1="/features/map9.svg"
          />

          <RectangleCard
            firsttext="Multiple AI models:"
            secondtext="Choose from a range of models such as GPT 4, GPT 4o, Claude 3 Opus, Claude 3.5 Sonnet, Gemini 1.5 Pro, and more to tailor your conversation."
            imgsrc1="/features/map10.svg"
          />
          <RectangleCard
            firsttext="Conversation history:"
            secondtext="Continue conversations where you left off, with a full log of past interactions."
            imgsrc1="/features/map11.svg"
          />

          <RectangleCard
            firsttext="Brand voice personalization:"
            secondtext="Maintain a consistent tone and style across your chats by saving preferences and styles, ensuring that your brand's voice is always aligned."
            imgsrc1="/features/map12.svg"
          />
          <RectangleCard
            firsttext="Download & share:"
            secondtext="Easily share or download your conversations for future reference."
