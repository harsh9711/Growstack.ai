...
const Box = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-8 sm:p-0 px-8">
...
const SixCard = () => {
  return (
    <div className="py-8 sm:p-0 md:p-4 p-6">
      <div className="max-w-[1340px] flex flex-col  md:items-center xl:items-start justify-center items-center gap-y-6 sm:gap-y-8 w-full mx-auto sm:py-40">
        <div
