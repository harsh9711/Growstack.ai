...
const AnimationStory = () => {
  ...
  return (
    <div className="relative w-full md:h-screen max-h-[550px] sm:max-h-[1000px] border-none outline-none overflow-y-hidden bg-[#F5F5F5] text-white">
      {/* Main video for tablet and larger screens */}
      <video
        ref={mainVideoRef}
        ...
        muted
        preload="auto"
        className={`absolute top-0 left-0 w-full h-full ease-out hidden sm:block transition-opacity duration-700 ${
      ...
      <div className="relative z-10 mx-auto flex flex-col items-center justify-center sm:mt-2 max-w-[1320px] p-4">
        <div className="flex w-full flex-col gap-6 sm:flex-row items-center justify-between">
          ...
          <div className="flex flex-col text-center sm:text-start sm:text-[16px] md:text-[20px] font-semibold">
            <h2 className="text-[#2DA771] text-start ml-1">
        ...
        <div className="block sm:hidden w-full mx-auto items-center justify-center max-w-[1320px] mt-6">
          <video
            ref={mobileVideoRef}
            src="https://growstack-static-content.s3.us-east-1.amazonaws.com/landingpagevideos.mp4"
            autoPlay
