...
const KeyPoints = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 justify-between items-center gap-10 p-8">
      {[
...
const AnimationStory = () => {
  return (
    <div className="mx-auto  mt-10 sm:mt-20 flex flex-col">
      {" "}
      <div className="mx-auto flex w-full flex-row  max-w-[1320px]  items-center justify-between">
        {" "}
        <h1 className="text-[16px] sm:text-start  max-w-[620px] w-full   text-center xl:text-[36px] 2xl:text-[42px] font-medium mb-1">
          AI for
          <span className="font-extrabold   text-[#2DA771] px-2">
            Smarter Writing, Engagement, & Automation
          </span>{" "}
        </h1>
        <span className="flex flex-col sm:text-[20px] font-semibold text-[16px]">
      ...
      <div className=" bg-white p-8 relative flex items-center justify-center">
        <div className="w-full max-w-4xl absolute z-20">
          ...
          > */}
            <path
              d="M1131 1C1132.6 54.2 1099.67 68.5 1083 69L730.5 76C654 76 630.194 79.5 622.5 108.5C612.1 147.7 583.667 149 570.5 151C455.167 150.167 203.5 149 119.5 151C35.5 153 6.5 82.5 2.5 47V8.5"
              stroke="white"
              stroke-width="4"
              className="stroke-[#ffffff]  -translate-y-2 stroke-[6]"
              fill="none"
              strokeLinecap="round"
            />{" "}
            <path
              ...
              stroke="white"
              stroke-width="4"
              className="stroke-[#ffffff]  translate-x-[310px] translate-y-8 relative z-0"
              fill="none"
              strokeLinecap="round"
            />
            <circle className="animate-moveBall1 fill-white" r="8">
              <animateMotion
                dur="4s"
            ...
            <circle
              className="animate-moveBall2 translate-x-80 translate-y-2 fill-white"
              r="8"
            >
              <animateMotion
                dur="10s"
