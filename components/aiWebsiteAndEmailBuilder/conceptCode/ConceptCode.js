          ...
          <div className="container">
            <div className="row ">
              ...
              >
                <div className="image">
                  <img
                    src="/images_growstack/emailBuilder/code.svg"
                    alt="conceptCode"
                  />
                </div>
              </div>
              ...
              >
                <div className="text">
                  ...
                  <p>
                    Choose the type of website you want and simply describe what
                    you need. Let AI craft a unique website for you with
                    relevant images and bespoke content. Use our powerful AI
                    tool to fine-tune your website until you're ready to hit 'Go
                    Live'.
                  </p>
