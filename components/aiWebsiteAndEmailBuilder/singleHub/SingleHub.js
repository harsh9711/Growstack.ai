            ...
            <div className="row">
              <div className="col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                <div className="content">
                  ...
                  <p>
                    Craft captivating emails effortlessly with our intuitive drag-and-drop editor, ensuring every message resonates with your audience.
                    Personalise content with dynamic elements tailored to each recipient's preferences and behaviour. Track performance in real-time with
                    comprehensive analytics, optimising engagement with actionable insights.
                  </p>
                  <div className="description">
                    <h5>Generate a template email</h5>
                    <p>
                      Enter a prompt describing your email's purpose. Our intelligent AI will instantly create a tailored email template designed specifically
                      for your needs.
                    </p>
                  </div>
                  <div className="description">
                    ...
                    <p>
                      Customise the generated email to fit your specific requirements. Modify the content, add personal touches, and ensure the message aligns
                  ...
                  <div className="description">
                    ...
                    <p>
                      Once satisfied with your email, save it and export it in your preferred format. Your professional email is now ready to be sent to your
                      audience.
                    </p>
                  </div>
                </div>
