  ...
  return (
    <div className=" hidden md:flex items-center ml-10">
      <div className=" relative flex items-center space-x-2  ">
        <Link
          href="/auth/login"
          className=" flex items-center text-[#2DA771] border-[#2DA771] border gap-4 text-lg px-5 py-2.5 rounded-lg transition-all duration-300 ease-in-out "
        >
          Login{" "}
          <svg
            width="16"
        ...
        <Link
          href="/auth/register"
          className=" whitespace-nowrap flex items-center text-[#2DA771] border-[#2DA771] border gap-4 text-lg sm:px-5 py-2.5 rounded-lg transition-all duration-300 ease-in-out "
        >
          Free trial{" "}
          <svg
            width="16"
