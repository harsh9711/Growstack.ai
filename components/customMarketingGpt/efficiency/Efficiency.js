          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            ...
            >
              <h3 className="heading">
                <span>Tailor-made custom GPT for</span> all your business
                interactions
              </h3>
            </div>
            <div
            ...
            >
              <p>
                You don't need to integrate dozens of different services, since
                GrowStack has it all
              </p>
            </div>
          </div>
                  ...
                  <div className="flex flex-col gap-12 ">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer1.svg"
                          alt="tailer1"
                        />
                      </div>
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer2.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer3.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer4.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                ...
                <div className="w-full sm:w-1/2 ">
                  <div className="flex flex-col gap-12 ">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer5.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer6.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer7.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
                    ...
                    >
                      <div className="flex-shrink-0">
                        <img
                          src="/images_growstack/customMarketing/tailer8.svg"
                          alt="tailer1"
                        />
                      </div>
                      <div className="flex-grow-1 relative ms-3">
