...
function Banner() {
  ...
  return (
    <React.Fragment>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="bannerContent">
                ...
                <h2>
                  <span>Build a personalized GPT</span> using your comprehensive business content
                </h2>
                <p>
                  Unleash the power of a custom GPT on your website—boost customer support, skyrocket lead generation, and captivate your users like never
                  before!
                </p>
      ...
      <div className="container">
        <div className="bannerCard" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000">
          <div className="block">
