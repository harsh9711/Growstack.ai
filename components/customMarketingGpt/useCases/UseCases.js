      ...
      <div className="useCases">
        <div className="container">
          <div className="flex flex-col sm:flex-row items-end">
            ...
            >
              <p>
                Custom GPTs aim to help you develop safe AI tailored for any
                role you need, whether it's for customer service, customer
                engagement, or document research
              </p>
            </div>
          </div>
          <div className="cases">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <div className="block">
                  <img
                    src="/images_growstack/customMarketing/case1.svg"
                    alt="case"
                  />
              ...
              >
                <div className="block">
                  <img
                    src="/images_growstack/customMarketing/case2.svg"
                    alt="case"
                  />
              ...
              >
                <div className="block">
                  <img
                    src="/images_growstack/customMarketing/case3.svg"
                    alt="case"
                  />
