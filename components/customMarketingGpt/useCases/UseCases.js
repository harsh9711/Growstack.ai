            ...
            <div className='useCases'>
                <div className='container'>
                    <div className='flex flex-col sm:flex-row items-end'>
                        <div className='w-full sm:w-1/3' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                            <span className='user'>Cases</span>
                            <h3 className='heading'>
                                <span>Use</span> cases
                            </h3>
                        </div>
                        <div className='w-full sm:w-2/3' data-aos='fade-left' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                            <p>
                                Custom GPTs aim to help you develop safe AI tailored for any role you need, whether it's for customer service,
                                customer engagement, or document research
                            </p>
                        </div>
                    </div>
                    <div className='cases'>
                    ...
                    <div className='try'>
                        <div className='content' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                            <h4>Try GrowStack AI</h4>
                            <p>What if Custom GPT knew all your business content?</p>
