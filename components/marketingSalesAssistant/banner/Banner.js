                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="bannerContent">
                                ...
                                <h2 className='mtitle'><span>AI powered</span> <br /> assistants
                                </h2>
                                <p>Revolutionize your organization with our AI-powered assistants, offering tailored experiences, boosting efficiency, and achieving maximum ROI across all departments.</p>
                                <div className="btns">
