        ...
        <div className="container">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="bannerContent">
              ...
              <p>
                Revolutionize your organization with our AI-powered assistants,
                offering tailored experiences, boosting efficiency, and
                achieving maximum ROI across all departments.
              </p>
              <div className="btns">
            ...
            <div className="">
              <Image
                src="/images_growstack/salesMarketing/banner.svg"
                width={1400}
                height={600}
                alt="banner"
              />
