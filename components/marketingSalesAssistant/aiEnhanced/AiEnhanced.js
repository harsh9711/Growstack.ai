        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-8" data-aos="fade-right"
                    ...
                    <h3 className="heading"><span>Revolutionize Customer Support with </span> <br /> AI-Enhanced Productivity</h3>
                </div>
                        ...
                        <div className="col-md-4" data-aos="fade-up"
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Deploy AI assistants across all departments to streamline operations and enhance team productivity.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4" data-aos="fade-up"
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Utilize AI-powered insights customized to your business needs for smarter decision-making and strategic growth.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4" data-aos="fade-up"
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Achieve quick wins and tangible business growth with the immediate impact of AI-powered assistants.</p>
                                </div>
                            </div>
                        </div>
                    </div>
