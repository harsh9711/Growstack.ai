...
const LoadingBar: React.FC = () => {
  ...
  const contents = [
    ...
    >
      <Image
        src="/images_growstack/solutions/datah1.svg"
        alt="Icon 1"
        width={50}
        height={50}
      />
    ...
    >
      <Image
        src="/images_growstack/solutions/datah2.svg"
        alt="Icon 2"
        width={50}
        height={50}
      />
    ...
    >
      <Image
        src="/images_growstack/solutions/datah3.svg"
        alt="Icon 3"
        width={50}
        height={50}
      />
    ...
    <div
      key="4"
      className={`flex flex-row items-center gap-x-10 ${clickedIndex === 3 ? "text-[#F0FFC3] font-semibold" : ""}`}
    >
      <Image
        src="/images_growstack/solutions/datah4.svg"
        alt="Icon 4"
        width={50}
        height={50}
      />
