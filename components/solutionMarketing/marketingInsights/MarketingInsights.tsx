...
const LoadingBar: React.FC = () => {
    ...
    const images: string[] = [
        '/images_growstack/solutions/data1.svg',
        '/images_growstack/solutions/data2.svg',
        '/images_growstack/solutions/data3.svg',
        '/images_growstack/solutions/data4.svg',
    ];
    const [clickedIndex, setClickedIndex] = useState<number | null>(null);

    const contents = [
        <div key="1"  className={`flex flex-row items-center gap-x-10 ${clickedIndex === 0 ? 'text-[#FFEDE6] font-semibold' : ''}`}>
            <Image src="/images_growstack/solutions/datah1.svg" alt="Icon 1" width={50} height={50} />
            <p className='text-black '>Targeted prospecting</p>
        </div>,
        <div key="2"  className={`flex flex-row items-center gap-x-10 ${clickedIndex === 1 ? 'text-[#9AEEE7] font-semibold' : ''}`}>
            <Image src="/images_growstack/solutions/datah2.svg" alt="Icon 2" width={50} height={50} />
            <p className='text-black '>Data insights</p>
        </div>,
        <div key="3"  className={`flex flex-row items-center gap-x-10 ${clickedIndex === 2 ? 'text-[#D9CFEE] font-semibold' : ''}`}>
            <Image src="/images_growstack/solutions/datah3.svg" alt="Icon 3" width={50} height={50} />
            <p className='text-black '>Brand monitoring</p>
        </div>,
        <div key="4"  className={`flex flex-row items-center gap-x-10 ${clickedIndex === 3 ? 'text-[#F0FFC3] font-semibold' : ''}`}>
            <Image src="/images_growstack/solutions/datah4.svg" alt="Icon 4" width={50} height={50} />
            <p className='text-black '>Performance metrics</p>
        </div>,
    ];
            ...
            <div className=" 2xl:items-start items-center justify-center flex flex-col gap-y-4 ">
               ...
               <h1
                ...
                >
                    ...
                    <span className="text-black bg-gradient-to-b from-black to-black/30 bg-clip-text text-transparent font-extralight">
                    data effectively       </span>
                </h1>
            </div>
