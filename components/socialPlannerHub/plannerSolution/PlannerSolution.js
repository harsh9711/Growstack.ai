...
const tabData = [
  {
    ...
    description:
      "Effortlessly plan and schedule your social media posts across platforms with our intuitive scheduler pages.",
  },
  {
    id: "conversation",
    ...
    description:
      "Effortlessly manage and engage in social media conversations across platforms.",
  },
  {
    id: "ads",
    title: "Ads analytics",
    ...
    description:
      "Analyze your social media ads performance with detailed analytics.",
  },
  {
    id: "analytics",
  ...
  },
  {
    ...
    description:
      "Manage your social media reputation effectively across various platforms.",
  },
];
              ...
              >
                <div className="accordionBlock">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    ...
                    <div>
                      <img
                        src="/images_growstack/social/accord.svg"
                        alt="accord"
                      />
                    </div>
                  </div>
