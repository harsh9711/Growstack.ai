          ...
          <div className="flex flex-col sm:flex-row items-center">
            ...
            >
              ...
              <h3 className="heading">
                <span>Expand your capabilities </span> <br /> with seamless
                integrations
              </h3>
            </div>
            <div
                  ...
                  <div className="cardsBlock grid grid-cols-1 sm:grid-cols-2 ">
                    <div className=" p-1">
                      <div className="block">
                        ...
                        <div className="content">
                          <img
                            src="/images_growstack/home/tstar.svg"
                            alt="star"
                          />
                          <p>
                    ...
                    <div className=" p-1">
                      <div className="block">
                        ...
                        <div className="content">
                          <img
                            src="/images_growstack/home/gstar.svg"
                            alt="star"
                          />
                          <p>
                    ...
                    <div className=" p-1">
                      <div className="block">
                        ...
                        <div className="content">
                          <img
                            src="/images_growstack/home/sstar.svg"
                            alt="star"
                          />
                          <p>
