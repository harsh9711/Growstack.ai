                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6" data-aos="fade-left"
                            data-aos-easing="ease-in-sine"
                            data-aos-duration="1000">
                            <p>Unlock the full potential of your business with integrated AI solutions for reputation management and automated communication.
                            </p>
                        </div>
                    </div>
                    <div className="row align-items-center mt-3 mt-md-5">
                        ...
                        <div className="col-md-12 col-lg-6" data-aos="fade-left"
                            ...
                            <div className="card whatsapp">
                                <div className="card-body">
                                    <div>
                                    <h5 className="card-title">WhatsApp and Telegram automation <span>with our apps</span></h5>
                                    <p className="card-text">
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-12" data-aos="fade-up"
                            ...
                            <div className="card discover">
                                <div className="card-body">
                                    <h5 className="card-title">Discover valuable contacts <span>with Google web scraping</span></h5>
                                    <p className="card-text">
                                        Use our Google web scraping tool to identify and collect contact details, enhancing your marketing and outreach efforts.
                                    </p>
                                </div>
                            </div>
                        </div>
