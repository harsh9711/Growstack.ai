...
export default function DropZone ({ provided, snapshot }: Props) {
   ...
   return (
      <div className={cn("relative z-20 mt-6 md:mt-8 lg:mt-10 transition-all 2xl:p-6 p-4   mx-auto bg-[#A7A7A7]/10 border border-primary-green/10 rounded-2.5xl overflow-hidden flex", !step ? 'w-[320px] 2xl:w-[505px] ' : 'w-4/5 md:w-[505px] lg:w-[420px] xl:w-[505px]')}>
         <div
            className={cn("relative bg-white w-full py-3 px-6 lg:x-28 lg:py-5 rounded-2.5xl border border-[#2B44E740]/25 border-dashed drop-shadow-2xl flex justify-center items-center before:absolute before:inset-0 before:bg-blue-400/10 before:border before:border-blue-300 before:rounded-2.5xl before:border-dashed before:opacity-0 ", snapshot.isDraggingOver && 'before:opacity-100')}
