...
export default function FeaturesCategory () {
   ...
   return (
      <div className="max-w-7.5xl mx-auto px-5 lg:px-10  py-8">
         <div className="rounded-2.5xl border border-[#EFEFEF] overflow-hidden p-4 2xl:p-6 bg-white -mt-16 2xl:-mt-20 relative z-20 drop-shadow-2xl">
            <div className="flex flex-row justify-center items-center xl:space-y-0 lg:space-x-6 space-x-4 xl:space-x-8.5">
               ...
               <div className=" flex 2xl:text-[14px]  text-[12px] items-center grow gap-4 lg:gap-0 flex-wrap lg:space-x-4">
