       ...
       <span className="items-center justify-center flex flex-row gap-8">    
        ...
        <div className="sm:hidden flex items-center justify-center space-x-5 ">
          <Link href="/auth/register">
            <h2 className=" inline-flex items-center space-x-3.5 2xl:text-[20px] text-[14px] min-w-['107px'] 2xl:h-14 h-10 border-2 border-primary-lightgreen text-primary-lightgreen rounded-lg sm:rounded-2xl p-2 2xl:px-4 2xl:py-3.5 hover:bg-primary-lightgreen hover:text-white">
