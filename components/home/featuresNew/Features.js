...
function Features() {
    ...
    if (fillPath && curveLine) {
      ...
      const handleScroll = () => {
        ...
        const percentDone = Math.max(
          ...
          Math.min(
            1,
            (startScroll - curveLineRect.top) /
              (curveLineRect.height + windowHeight)
          )
        );
      ...
      <div className="features">
        <div className="container">
          ...
          >
            ...
            <p className="m-0">
              From AI Templates, Assistants to Social Media Analytics, explore
              how GrowStack's suite of tools can elevate your business to new
              heights.
            </p>
          </div>
            ...
            <div className="curveLine" ref={curveLineRef}>
              ...
              >
                <div className="row ">
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock1.svg"
                      alt="Overcome creative block"
                  ...
                  <div className="">
                    ...
                    <p>
                      Turn ideas into reality with AI Chat, AI Playground, and
                      Custom GPT—your toolkit for breaking creative blocks. Get
                      frictionless, dynamic content, and custom AI solutions to
              ...
              >
                <div className="row ">
                  <div className="">
                    ...
                    <p>
                      Turn your sparks of creativity into content effortlessly.
                      With AI Templates, Text to Video, and Product AI, you have
                      the power to bring your ideas to life.
                    </p>
                    <ul>
                  ...
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock2.svg"
                      alt="Transform ideas into content"
                      className="feature-image textEnd"
                    />
                  </div>
                </div>
              </div>
              ...
              >
                <div className="row ">
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock3.svg"
                      alt="Strategize with AI assistants"
                      className="feature-image"
                    />
                  </div>
                  <div className="">
                    ...
                    <p>
                      Transform raw ideas into strategic masterpieces. Our AI
                      Assistants cover every aspect of content strategy, from
                      trend tracking and social engagement to lead qualification
  ...
  <path d="M115 0L116 966" stroke="#034737" strokeWidth="3" strokeDasharray="1000" strokeDashoffset="1000" />
              ...
              >
                <img
                  src="/images_growstack/home/fBlock4.svg"
                  alt="Elevate your ideas into presentable content"
                  className="feature-image"
                />
                <h3>Elevate your ideas into presentable content</h3>
                <p>
                  Streamline your strategy with our content builders: the AI
                  Article Builder for engaging articles, the AI Email Builder
                  for impactful messages, and the AI Website Builder for
                  stunning sites. Present your ideas boldly and effectively.
                </p>
                <ul>
                  <li>Storytelling</li>
              ...
              >
                <img
                  src="/images_growstack/home/fBlock5.svg"
                  alt="Gather insights from your audience"
                  className="feature-image"
                />
                <h3>Gather insights from your audience</h3>
                <p>
                  Collect and analyze ideas from various sources to enhance your
                  outreach. With tools for Google Maps scraping, social media
                  conversations, and more, you gain invaluable insights into
                  your audience.
                </p>
                <ul>
                  <li>Lead tracking</li>
            ...
            <div className="trophyLine">
              ...
              >
                <div className="row ">
                  <div className="">
                    ...
                    <p>
                      Optimize your processes effortlessly with our AI Workflow
                      Builder. Automate tasks across various verticals to boost
                      productivity and efficiency.
                    </p>
                  </div>
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock6.svg"
                      alt="Streamline your processes with AI workflow builder"
                      className="feature-image"
                    />
                  </div>
                  <div className="">
              ...
              >
                <div className="row ">
                  <div className="">
                    ...
                    <p>
                      Seamlessly share your articles, blogs, and content across
                      all social media platforms. With automated scheduling and
                      optimized posting times, you can maximize your reach and
                      engagement without the hassle.
                    </p>
                    <ul>
                  ...
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock7.svg"
                      alt="Effortless publishing with scheduler"
                      className="feature-image"
                    />
                  </div>
                </div>
              ...
              >
                <div className="row ">
                  <div className="">
                    <img
                      src="/images_growstack/home/fBlock8.svg"
                      alt="Analyze your impact"
                      className="feature-image"
                    />
                  </div>
                  <div className="">
                    ...
                    <p>
                      Unlock insights with our analytics tools. Track social
                      media performance, manage your online reputation, and
                      refine your strategies. Measure engagement and analyze
                      sentiment for maximum impact.
                    </p>
                    <ul>
