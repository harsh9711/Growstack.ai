        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12 col-lg-6" data-aos="fade-right"
                    ...
                    <span className="user">Take Control</span>
                    <h3>On-The-Go with our mobile app <span>integrated CRM platform built for success</span></h3>
                    <p>Stay productive anywhere with real-time control and insights, effortlessly managing your business with our intuitive mobile app
                    </p>
                    <Link href="/auth/register" className='sheen flex flex-row getStart'>Get Started <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
