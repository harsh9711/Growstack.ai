  ...
  return (
    <div className="w-full h-full transition transform duration-1000 ease-linear">
      {items.map((item, index) => {
        ...
        return (
          <div key={index} className="mb-4 w-full   bg-white border text-[12px] sm:text-[20px] rounded-[20px] font-bold items-start ease-in-out transition-transform duration-1000 cursor-pointer">
            <div
            ...
            >
              ...
              <div
                className={`sm:flex hidden ease-in-out transition-transform duration-300 items-center justify-center sm:border sm:w-12 sm:h-12 bg-${isActive ? "primary-green" : "white"} rounded-full ${isActive ? "-rotate-180" : "rotate-75"}`}
              >
