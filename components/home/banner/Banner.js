                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="bannerContent">
                                ...
                                <h2 className='textTitle'><span>Your AI Catalyst for</span> <br /> business success!
                                </h2>
                                <p>AI is transforming the way we work. GrowStack transforms your business into an innovation powerhouse, driving unmatched productivity and meaningful progress.</p>
                                <div className="btns btnFlex">
                                    <Link href="/register" className='sheen'>Free trial <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link href="/register" className='sheen'>Get a demo <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.5061 8.70711C20.8966 8.31658 20.8966 7.68342 20.5061 7.29289L14.1421 0.928932C13.7516 0.538408 13.1184 0.538408 12.7279 0.928932C12.3374 1.31946 12.3374 1.95262 12.7279 2.34315L18.3848 8L12.7279 13.6569C12.3374 14.0474 12.3374 14.6805 12.7279 15.0711C13.1184 15.4616 13.7516 15.4616 14.1421 15.0711L20.5061 8.70711ZM0 9L19.799 9V7L0 7L0 9Z" fill="#fff" />
                                    </svg>
                                    </Link>
                                </div>
                                <div className="sale">
                                    ...
                                    <img src="/images/banner/tri.svg" alt="banner" />
                                </div>
                                <div className="store">
                        ...
                        <div className="col-lg-6 bannerImg">
                                <img src="/images/banner/banner.svg" alt="banner" />
                        </div>
                    </div>
                </div>
