    ...
    return (
        <React.Fragment>
            ...
            data-aos-duration="1000">
                            ...
                            <h2 className='heading'><span>Discover our powerful</span> <br /> AI features</h2>
                        </div>
                        <div className="col-md-6" data-aos="fade-up"
            data-aos-easing="ease-in-sine"
            data-aos-duration="1000">
                            <p className='m-0'>From AI Templates, Assistants to Social Media Analytics, explore how GrowStack's suite can elevate your business to new heights</p>
                        </div>
                    </div>
                </div>
                <div className="block">
