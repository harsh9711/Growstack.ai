            ...
            <div className="scaling">
              <div className="card">
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  ...
                  >
                    <img
                      src="/images_growstack/textVideo/scaling.svg"
                      className="img-fluid"
                      alt="banner"
                    />
                  </div>
                  ...
                  >
                    <div className="card-body">
                      ...
                      <p>
                        Professional quality videos from your script complete
                        with realistic AI voices, matching footage and music in
                        just a few clicks.
                      </p>
              ...
              <div className="flex flex-col sm:flex-row py-3 items-center gap-12 sm:gap-24">
                ...
                >
                  <div className="content">
                    ...
                    <p>
                      How fast is AI Product Photos? Lightning fast! What once
