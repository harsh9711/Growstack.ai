      ...
      <div className="aiProduct">
        ...
        <div className="wrapper">
          <div className="container">
            ...
            <div className="block">
              <div className="row align-items-center">
                <div className="col-lg-5 col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                  <div className="imgBlock">
                    <img src="/images_growstack/textVideo/ai1.svg" alt="img" />
                  </div>
                </div>
                <div className="col-lg-1 none"></div>
                <div className="col-lg-5 col-md-6" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-duration="1000">
              ...
              <div className="row align-items-center">
                <div className="col-lg-5 col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                  <div className="content">
                    ...
                    <p>
                      How fast is AI Product Photos? Lightning fast! What once required days and weeks in a photo studio can now be accomplished in seconds. Bid
                      farewell to traditional product photoshoots and greet Product AI's instant AI background generator. Just upload a photo of your product,
                      and our AI photo generator will breathe life into your brand with AI Product Photos.
                    </p>
                    <div className="btns">
                      <Link href="/auth/register" className="sheen">
                        Create AI product photos{" "}
