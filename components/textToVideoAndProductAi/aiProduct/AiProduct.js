            ...
            <div className="scaling">
                        <div className="card">
                            ...
                            data-aos-duration="1000">
                                    <div className="card-body">
                                        ...
                                        <p>Professional quality videos from your script complete with realistic AI voices, matching footage and music in just a few clicks.</p>
                ...
                <div className="container">
                        <div className="row align-items-end mb-3 mb-md-5">
                            ...
                            data-aos-duration="1000">
                                <span className="user">From idea to video in minutes 🔥</span>
                                <h3 className="heading mt-2 mb-2 mb-md-0"><span>Product AI </span> photots</h3>
                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 col-md-6" data-aos="fade-left"
                            ...
                            <div className="content">
                                ...
                                <p>Product AI's Photo Maker presents a spectrum of styles to craft compelling product photos. Our AI-generated backgrounds are incredibly lifelike, offering hundreds of choices instantly. With dozens of styles at your fingertips, effortlessly find one that enhances your brand's aesthetic. Craft stunning Product AI Photos that resonate with your brand using our intuitive AI image generator, available for free!</p>
                                    <div className="btns">
                                        <Link href="/register" className='sheen'>Create AI product photos <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20.5061 8.70711C20.8966 8.31658 20.8966 7.68342 20.5061 7.29289L14.1421 0.928932C13.7516 0.538408 13.1184 0.538408 12.7279 0.928932C12.3374 1.31946 12.3374 1.95262 12.7279 2.34315L18.3848 8L12.7279 13.6569C12.3374 14.0474 12.3374 14.6805 12.7279 15.0711C13.1184 15.4616 13.7516 15.4616 14.1421 15.0711L20.5061 8.70711ZM0 9L19.799 9V7L0 7L0 9Z" fill="black" />
                                        </svg></Link>
                                    </div>
                            </div>
                    ...
                    <div className="col-lg-5 col-md-6" data-aos="fade-right"
                            ...
                            <div className="content">
                                <h3>Instant results, 
                                professional appearance</h3>
                                <p>How fast is AI Product Photos? Lightning fast! What once required days and weeks in a photo studio can now be accomplished in seconds. Bid farewell to traditional product photoshoots and greet Product AI's instant AI background generator. Just upload a photo of your product, and our AI photo generator will breathe life into your brand with AI Product Photos.</p>
                                    <div className="btns">
                                        <Link href="/register" className='sheen'>Create AI product photos <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20.5061 8.70711C20.8966 8.31658 20.8966 7.68342 20.5061 7.29289L14.1421 0.928932C13.7516 0.538408 13.1184 0.538408 12.7279 0.928932C12.3374 1.31946 12.3374 1.95262 12.7279 2.34315L18.3848 8L12.7279 13.6569C12.3374 14.0474 12.3374 14.6805 12.7279 15.0711C13.1184 15.4616 13.7516 15.4616 14.1421 15.0711L20.5061 8.70711ZM0 9L19.799 9V7L0 7L0 9Z" fill="black" />
                                        </svg></Link>
