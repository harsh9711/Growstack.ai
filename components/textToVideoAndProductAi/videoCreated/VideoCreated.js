      ...
      <div className="videoCreated">
        <div className="container">
          ...
          <div className="allArticles">
            <div className="card" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000">
            ...
            <div className="card" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000">
              <div className="row align-items-center g-0">
                ...
                <div className="col-md-7">
                  <div className="card-body">
                    <h5>Turn blog posts into videos for better sEO and reduced bounce rates</h5>
            ...
            <div className="card" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000">
              <div className="row align-items-center g-0">
                ...
                <div className="col-md-7">
                  <div className="card-body">
                    <h5>Transform long-form videos into engaging branded clips for social media</h5>
                    <p>Professional quality videos from your script complete with realistic AI voices, matching footage and music in just a few clicks.</p>
                    <div className="btns">
                      <Link href="/auth/register" className="sheen">
                        Read More{" "}
          ...
          <div className="laptopImg" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000">
