                ...
                <div className='container'>
                    <div className='flex flex-col sm:flex-row items-center mb-0'>
                        ...
                        <div className='w-full sm:w-1/2' data-aos='fade-left' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                            <p>
                                Transform your brand's presence and engagement with AI-powered videos, harnessing advanced technology to captivate
                                audiences and elevate your market impact.
                            </p>
                        </div>
                    </div>
                    <div className='row'>
                                    ...
                                    <div className='card'>
                                        <div className='card-body'>
                                            ...
                                            <p className='card-text'>
                                                Plan and execute a video content strategy that will significantly increase your brand’s exposure,
                                ...
                                <div className='col-md-4' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                                    <div className='card'>
                                        <div className='card-body'>
                                            ...
                                            <p className='card-text'>
                                                Increase the scale and speed of your video creation. Save time, maximize resources and lower
                                                production costs.
                                            </p>
                                        </div>
                                    </div>
