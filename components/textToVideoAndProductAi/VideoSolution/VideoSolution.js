...
function VideoSolution() {
    ...
    return (
        <React.Fragment>
            <div className="embedSlider" data-aos="fade-up"
            ...
            <div className='VideoSolution'>
                <div className="container">
                    <div className='text-center mb-4 mb-md-5' data-aos="fade-up"
                        ...
                        <h2 class="heading"><span>Your all in one AI</span> video solution</h2>
                    </div>
                </div>
                <div className='container'>
                    <div className='video-frames-wrap'>
                        <div className='row mb-3 mb-md-5' data-aos="fade-up"
                            data-aos-easing="ease-in-sine"
                            data-aos-duration="1000">
                            <div className='col-lg-6 col-md-6'>
                                <div className='frames-wrap'>
                                    <div className='frames-wrap-inner'>
                                        ...
                                        <p>Transform your written content into dynamic, engaging videos effortlessly with our AI-powered tool. Simply input your text, customize the style, and watch as your words come to life with high-quality visuals and audio. </p>
                                        <p>Perfect for marketers, educators, and content creators looking to captivate their audience quickly and easily.</p>
                                        <Link href='' className='sheen flex flex-row'>Generate a video<svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='row mb-3 mb-md-5  flex-row-reverse' data-aos="fade-up"
                            data-aos-easing="ease-in-sine"
                            data-aos-duration="1000">
                            <div className='col-lg-6 col-md-6'>
