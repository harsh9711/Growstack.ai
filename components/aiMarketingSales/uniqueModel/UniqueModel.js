        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model1.svg" width={100} height={100} alt="icon" />
                ...
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model2.svg" width={100} height={100} alt="icon" />
                ...
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model3.svg" width={100} height={100} alt="icon" />
                ...
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model4.svg" width={100} height={100} alt="icon" />
                ...
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model5.svg" width={100} height={100} alt="icon" />
                ...
                <div className="col-md-4 my-2 my-md-2 px-2" data-aos="fade-up"
                            ...
                            data-aos-duration="1000">
                    <div className="card">
                    <Image src="/images/aiMarket/model6.svg" width={100} height={100} alt="icon" />
