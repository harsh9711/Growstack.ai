        ...
        <div className="container">
          <div className="head">
            <div data-aos="fade-right"
              ...
              <h3 className="heading"><span>Don’t take our words </span> for it listen to our customers</h3>
            </div>
            <div className="btns" data-aos="fade-left"
              data-aos-easing="ease-in-sine"
              data-aos-duration="1000">
              <Link href="/all-stories" className='sheen'>See all stories <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
