                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
                                    <div className='col-md-4' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                                        <div className='card'>
                                            <div className='card-body'>
                                                <div className='icon'>
                                                    <img src='/images_growstack/aiMarket/choose1.svg' alt='icon' />
                                                </div>
                                                <h5 className='card-title'>Improved content quality</h5>
                                                <p className='card-text'>
                                                    AI ensures that content is consistent in tone, style, and accuracy, adhering to brand guidelines
                                    ...
                                    <div className='col-md-4' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                                        <div className='card'>
                                            <div className='card-body'>
                                                <div className='icon'>
                                                    <img src='/images_growstack/aiMarket/choose2.svg' alt='icon' />
                                                </div>
                                                <h5 className='card-title'>Cost-effectiveness</h5>
                                                <p className='card-text'>
                                                    By automating the content creation process, AI writing tools can significantly reduce the need for
                                                    extensive human labor, lowering costs associated with hiring writers, editors, and proofreaders.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-md-4' data-aos='fade-up' data-aos-easing='ease-in-sine' data-aos-duration='1000'>
                                        <div className='card'>
                                            <div className='card-body'>
                                                <div className='icon'>
                                                    <img src='/images_growstack/aiMarket/choose3.svg' alt='icon' />
                                                </div>
                                                <h5 className='card-title'>Innovation and creativity</h5>
                                                <p className='card-text'>
                                                    AI tools can assist in brainstorming and generating new ideas for content, helping writers
                                                    overcome creative blocks and explore new topics and angles.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
