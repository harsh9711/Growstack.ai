            ...
            <div className="row align-items-center">
              <div className="col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                <div className="content">
                  ...
                  <p>
                    AI writing tools excel at generating diverse content, from concise social media posts and product descriptions to comprehensive articles,
                    reports, and even ebooks. Their versatility ensures consistent, high-quality content across all platforms, making them indispensable for
                    businesses and individuals aiming to maintain a robust and engaging presence.
                  </p>
                  <div className="btns">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                <div className="content">
                  ...
                  <p>
                    Create high-converting content with 80+ AI templates. From business bios and Facebook ads to emails and YouTube descriptions, our AI content
                    generator delivers compelling copy tailored to your needs, ensuring you reach a global audience effortlessly.
                  </p>
                  <div className="btns">
                    <Link href="/auth/register" className="sheen">
                      Get started{" "}
